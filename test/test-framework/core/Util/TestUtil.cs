...
namespace Lucene.Net.Util
{
    ...
    using TermIndexStatus = Lucene.Net.Index.CheckIndex.Status.TermIndexStatus;
    using TermVectorStatus = Lucene.Net.Index.CheckIndex.Status.TermVectorStatus;
