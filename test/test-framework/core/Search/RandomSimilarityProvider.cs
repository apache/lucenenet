...
namespace Lucene.Net.Search
{
	...
	using BasicModelBE = Lucene.Net.Search.Similarities.BasicModelBE;
	using BasicModelD = Lucene.Net.Search.Similarities.BasicModelD;
	...
	using BasicModelP = Lucene.Net.Search.Similarities.BasicModelP;
	...
	using LMDirichletSimilarity = Lucene.Net.Search.Similarities.LMDirichletSimilarity;
	...
	public class RandomSimilarityProvider : PerFieldSimilarityWrapper
	{
	  ...
	  public override Similarity Get(string field)
	  {
		  lock (this)
		  {
			...
			Similarity sim = PreviousMappings[field];
			if (sim == null)
			{
