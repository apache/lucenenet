...
namespace Lucene.Net.Codecs.Compressing.dummy
{
	...
	public class DummyCompressingCodec : CompressingCodec
	{
	  ...
	  public DummyCompressingCodec(int chunkSize, bool withSegmentSuffix) : base("DummyCompressingStoredFields", withSegmentSuffix ? "DummyCompressingStoredFields" : "", DUMMY, chunkSize)
	  {
	  }
