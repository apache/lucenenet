namespace Lucene.Net.Codecs.Compressing
{
	...
	public class HighCompressionCompressingCodec : CompressingCodec
	{
	  ...
	  public HighCompressionCompressingCodec(int chunkSize, bool withSegmentSuffix) : base("HighCompressionCompressingStoredFields", withSegmentSuffix ? "HighCompressionCompressingStoredFields" : "", CompressionMode.HIGH_COMPRESSION, chunkSize)
	  {
	  }
