...
namespace Lucene.Net.Codecs.Compressing
{
	...
	public abstract class CompressingCodec : FilterCodec
	{
	  ...
	  /// </summary>
	  public CompressingCodec(string name, string segmentSuffix, CompressionMode compressionMode, int chunkSize) : base(name, new Lucene46Codec())
	  {
	  ...
	  /// </summary>
	  public CompressingCodec(string name, CompressionMode compressionMode, int chunkSize) : this(name, "", compressionMode, chunkSize)
	  {
	  }
