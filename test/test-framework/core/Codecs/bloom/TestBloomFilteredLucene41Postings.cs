namespace Lucene.Net.Codecs.bloom
{
	...
	/// <summary>
	/// A class used for testing <seealso cref="BloomFilteringPostingsFormat"/> with a concrete
	...
	public sealed class TestBloomFilteredLucene41Postings : PostingsFormat
	{
	  ...
	  {
		@delegate = new BloomFilteringPostingsFormat(new Lucene41PostingsFormat(), new LowMemoryBloomFactory());
	  }
