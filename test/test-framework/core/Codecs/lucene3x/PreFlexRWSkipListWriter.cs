namespace Lucene.Net.Codecs.Lucene3x
{
	...
	public class PreFlexRWSkipListWriter : MultiLevelSkipListWriter
	{
	  ...
	  public PreFlexRWSkipListWriter(int skipInterval, int numberOfSkipLevels, int docCount, IndexOutput freqOutput, IndexOutput proxOutput) : base(skipInterval, numberOfSkipLevels, docCount)
	  {
