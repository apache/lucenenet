...
namespace Lucene.Net.Codecs.Lucene3x
{
	...
	internal class PreFlexRWTermVectorsFormat : Lucene3xTermVectorsFormat
	{
	  ...
	  private class Lucene3xTermVectorsReaderAnonymousInnerClassHelper : Lucene3xTermVectorsReader
	  {
		  ...
		  public Lucene3xTermVectorsReaderAnonymousInnerClassHelper(PreFlexRWTermVectorsFormat outerInstance, Directory directory, SegmentInfo segmentInfo, FieldInfos fieldInfos, IOContext context) : base(directory, segmentInfo, fieldInfos, context)
		  {
