...
namespace Lucene.Net.Index
{
    ...
    internal class DocHelper
    {
        ...
        public static string FIELD_1_TEXT = "field one text";
        public static string TEXT_FIELD_1_KEY = "textField1";
        ...
        public static string FIELD_2_TEXT = "field field field two text";
        //Fields will be lexicographically sorted.  So, the order is: field, text, two
        public static readonly int[] FIELD_2_FREQS = new int[] { 3, 1, 1 };
        public static string TEXT_FIELD_2_KEY = "textField2";
        public static Field TextField2;

        public static readonly FieldType CustomType3;
        public static string FIELD_3_TEXT = "aaaNoNorms aaaNoNorms bbbNoNorms";
        public static string TEXT_FIELD_3_KEY = "textField3";
        public static Field TextField3;


        public static string KEYWORD_TEXT = "Keyword";
        public static string KEYWORD_FIELD_KEY = "keyField";
        public static Field KeyField;

        public static readonly FieldType CustomType5;
        public static string NO_NORMS_TEXT = "omitNormsText";
        public static string NO_NORMS_KEY = "omitNorms";
        public static Field NoNormsField;

        public static readonly FieldType CustomType6;
        public static string NO_TF_TEXT = "analyzed with no tf and positions";
        public static string NO_TF_KEY = "omitTermFreqAndPositions";
        public static Field NoTFField;

        public static readonly FieldType CustomType7;
        public static string UNINDEXED_FIELD_TEXT = "unindexed field text";
        public static string UNINDEXED_FIELD_KEY = "unIndField";
        public static Field UnIndField;


        public static string UNSTORED_1_FIELD_TEXT = "unstored field text";
        public static string UNSTORED_FIELD_1_KEY = "unStoredField1";
        ...
        public static string UNSTORED_2_FIELD_TEXT = "unstored field text";
        public static string UNSTORED_FIELD_2_KEY = "unStoredField2";
        public static Field UnStoredField2;

        public static string LAZY_FIELD_BINARY_KEY = "lazyFieldBinary";
        public static sbyte[] LAZY_FIELD_BINARY_BYTES;
        public static Field LazyFieldBinary;

        public static string LAZY_FIELD_KEY = "lazyField";
        public static string LAZY_FIELD_TEXT = "These are some field bytes";
        public static Field LazyField = new Field(LAZY_FIELD_KEY, LAZY_FIELD_TEXT, CustomType);

        public static string LARGE_LAZY_FIELD_KEY = "largeLazyField";
        public static string LARGE_LAZY_FIELD_TEXT;
        public static Field LargeLazyField;

        //From Issue 509
        public static string FIELD_UTF1_TEXT = "field one \u4e00text";
        public static string TEXT_FIELD_UTF1_KEY = "textField1Utf8";
        public static Field TextUtfField1 = new Field(TEXT_FIELD_UTF1_KEY, FIELD_UTF1_TEXT, CustomType);

        public static string FIELD_UTF2_TEXT = "field field field \u4e00two text";
        //Fields will be lexicographically sorted.  So, the order is: field, text, two
        public static readonly int[] FIELD_UTF2_FREQS = new int[] { 3, 1, 1 };
        public static string TEXT_FIELD_UTF2_KEY = "textField2Utf8";
        ...
        public static Field[] Fields = new Field[] { TextField1, TextField2, TextField3, KeyField, NoNormsField, NoTFField, UnIndField, UnStoredField1, UnStoredField2, TextUtfField1, TextUtfField2, LazyField, LazyFieldBinary, LargeLazyField };
