    ...
    public class TestIndexReader:LuceneTestCase
    {
        ...
        private void  AssertTermDocsCount(System.String msg, IndexReader reader, Term term, int expected)
        {
            ...
            try
            {
                ...
                Assert.IsNotNull(msg + ", null TermDocs", tdocs);
                int count = 0;
                while (tdocs.Next())
                {
                    count++;
            ...
            while (!done)
            {
                ...
                for (int x = 0; x < 2; x++)
                {
                    ...
                    if (!CollectionsHelper.Equals(startFiles, endFiles))
                    {
                        ...
                        Assert.Fail("reader.Dispose() failed to delete unreferenced files after " + successStr + " (" + diskFree + " bytes): before delete:\n    " + ArrayToString(startFiles) + "\n  after delete:\n    " + ArrayToString(endFiles));
                    }
        ...
        public virtual void  TestDocsOutOfOrderJIRA140()
        {
            ...
            // InvalidOperationException because above out-of-bounds
        ...
        public virtual void  TestIndexReader_Rename()
        {
            ...
            reader.Dispose();
            IndexReader.Open(dir, true).Dispose();
        }
        ...
        public virtual void  TestIndexReaderUnDeleteAll()
        {
            ...
            reader.DeleteDocuments(new Term("id", "b"));
            reader.Dispose();
            IndexReader.Open(dir, false).Dispose();
            dir.Dispose();
        }
