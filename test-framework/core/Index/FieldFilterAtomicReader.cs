...
namespace Lucene.Net.Index
{
	...
	public sealed class FieldFilterAtomicReader : FilterAtomicReader
	{
	  ...
	  private readonly Set<string> Fields_Renamed;
	  private readonly bool Negate;
	  private readonly FieldInfos FieldInfos_Renamed;

	  public FieldFilterAtomicReader(AtomicReader @in, Set<string> fields, bool negate) : base(@in)
	  {
	  ...
	  private class FieldFilterFields : FilterFields
	  {
		...
		public FieldFilterFields(FieldFilterAtomicReader outerInstance, Fields @in) : base(@in)
		{
			this.OuterInstance = outerInstance;
		}
		...
		private class FilterIteratorAnonymousInnerClassHelper : FilterIterator<string>
		{
			...
			public FilterIteratorAnonymousInnerClassHelper(FieldFilterFields outerInstance, IEnumerator<string> iterator) : base(iterator)
			{
				this.OuterInstance = outerInstance;
			}
