...
namespace Lucene.Net.Index
{
    ...
    public class TestIndexWriter : LuceneTestCase
    {
        ...
        */
        ...
        /// <summary> Test that no System.ArgumentNullException will be raised,
        /// when adding one document with a single, empty field
        /// and term vectors enabled.
        /// </summary>
        /// <throws>  System.IO.IOException </throws>
        /// <summary> 
        /// </summary>
        [Test]
...
//System.Console.Out.WriteLine("TRACE> ");
                    ...
                    {
//if (frames[i].GetMethod().DeclaringType.ToString().StartsWith("Lucene.Net"))
//System.Console.Out.WriteLine(frames[i].GetMethod().DeclaringType.ToString() + " " + frames[i].GetMethod().Name);
                        if ("Lucene.Net.Index.FreqProxTermsWriter".Equals(frames[i].GetMethod().DeclaringType.ToString()) &&
                            "AppendPostings".Equals(frames[i].GetMethod().Name))
                            sawAppend = true;
                        if ("DoFlush".Equals(frames[i].GetMethod().Name))
                            sawFlush = true;
                    }
        ...
        private class CrashingFilter : TokenFilter
        {
            ...
            public CrashingFilter(TestIndexWriter enclosingInstance, string fieldName, TokenStream input)
                : base(input)
            {
                InitBlock(enclosingInstance);
                ...
                while ((System.DateTime.Now.Ticks - 621355968000000000) / 10000 < stopTime)
                {
                    ...
                    catch (System.IO.IOException ioe)
                    {
                        ...
                        else
                        {
                            if (noErrors)
                            {
                                System.Console.Out.WriteLine(SupportClass.ThreadClass.Current().Name + ": ERROR: unexpected System.IO.IOException:");
                    ...
                    catch (System.Exception t)
                    {
                        ...
                        if (noErrors)
                        {
                            System.Console.Out.WriteLine(SupportClass.ThreadClass.Current().Name + ": ERROR: unexpected System.Exception:");
                            System.Console.Out.WriteLine(t.StackTrace);
                            error = t;
                        }
                        break;
        ...
        public virtual void TestCloseWithThreads()
        {
            ...
            for (int iter = 0; iter < 20; iter++)
            {
                ...
                while (!done)
                {
                    try
                    {
                        System.Threading.Thread.Sleep(new System.TimeSpan((System.Int64)1000 * 100));
                    }
                    catch (System.Threading.ThreadInterruptedException)
                    {
                        SupportClass.ThreadClass.Current().Interrupt();
            ...
            for (int iter = 0; iter < 10; iter++)
            {
                ...
                for (int i = 0; i < NUM_THREADS; i++)
                {
                    ...
                    if (threads[i].IsAlive)
                        ...
                        Assert.IsTrue(threads[i].error == null, "hit unexpected System.Exception");
                }
        ...
        // Throws System.IO.IOException during FieldsWriter.flushDocument and during DocumentsWriter.abort
                ...
                if (doFail)
                {
                    ...
                    for (int i = 0; i < frames.Length; i++)
                    {
                        ...
                        if ("Abort".Equals(methodName) || "FlushDocument".Equals(methodName))
                        {
                            ...
                            //new System.Exception().printStackTrace(System.out);
        ...
        // to trigger an System.IO.IOException
        ...
        // failure to trigger an System.IO.IOException
        ...
        // LUCENE-1130: make sure initial System.IO.IOException, and then 2nd
        // System.IO.IOException during abort(), is OK:
        [Test]
        ...
        // LUCENE-1130: make sure initial System.IO.IOException, and then 2nd
        // System.IO.IOException during abort(), with multiple threads, is OK:
        [Test]
        ...
        // Throws System.IO.IOException during DocumentsWriter.closeDocStore
        ...
        // LUCENE-1130: test System.IO.IOException in closeDocStore
        [Test]
        ...
        // LUCENE-1130: test System.IO.IOException in closeDocStore, with threads
        [Test]
        ...
        // Throws System.IO.IOException during DocumentsWriter.writeSegment
        private class FailOnlyInWriteSegment : MockRAMDirectory.Failure
        {
            ...
            public override void Eval(MockRAMDirectory dir)
            {
                if (doFail)
                {
                    ...
                    {
                        string methodName = frames[i].GetMethod().Name;
                        if ("Flush".Equals(frames[i].GetMethod().Name) &&
                            "Lucene.Net.Index.DocFieldProcessor".Equals(frames[i].GetMethod().DeclaringType.ToString()))
                        {
                            if (onlyOnce)
                                doFail = false;
                            throw new System.IO.IOException("now failing on purpose");
        ...
        // LUCENE-1130: test System.IO.IOException in writeSegment
        [Test]
        ...
        // LUCENE-1130: test System.IO.IOException in writeSegment, with threads
        [Test]
        ...
        [Test]
        public void TestUnlimitedMaxFieldLength()
        {
            Directory dir = new MockRAMDirectory();
        ...
        [Test]
        public void TestSegmentsChecksumError()
        {
            Directory dir = new MockRAMDirectory();
        ...
        // Throws System.IO.IOException during MockRAMDirectory.sync
        private class FailOnlyInSync : MockRAMDirectory.Failure
        {
            ...
            public override void Eval(MockRAMDirectory dir)
            {
                if (doFail)
                {
                    ...
                    for (int i = 0; i < frames.Length; i++)
                    {
                        if (doFail && "Sync".Equals(frames[i].GetMethod().Name) &&
                            "Lucene.Net.Store.MockRAMDirectory".Equals(frames[i].GetMethod().DeclaringType.ToString()))
                        {
                            didFail = true;
        ...
        [Test]
        public void TestExceptionDuringSync()
        {
            MockRAMDirectory dir = new MockRAMDirectory();
        ...
        [Test]
        public void TestUserSpecifiedMaxFieldLength()
        {
            Directory dir = new MockRAMDirectory();
        ...
        [Test]
        public void TestExpungeDeletes2()
        {
            Directory dir = new MockRAMDirectory();
            IndexWriter writer = new IndexWriter(dir,
                                                 new StandardAnalyzer(),
        ...
        [Test]
        public void TestExpungeDeletes3()
        {
            Directory dir = new MockRAMDirectory();
            IndexWriter writer = new IndexWriter(dir,
                                                 new StandardAnalyzer(),
        ...
        {
            public MockIndexWriter(Directory dir, Analyzer a, bool create, MaxFieldLength mfl)
        ...
        {
            public MockIndexWriter2(Directory dir, Analyzer a, bool create, MaxFieldLength mfl)
                :
              base(dir, a, create, mfl)
            {
            }
        ...
        {
            public MockIndexWriter3(Directory dir, Analyzer a, bool create, MaxFieldLength mfl)
                :
              base(dir, a, create, mfl)
            {
            }
        ...
        private class FailOnlyInCommit : MockRAMDirectory.Failure
        {
            ...
            public override void Eval(MockRAMDirectory dir)
            {
                ...
                bool isCommit = false;
                bool isDelete = false;
//System.Console.Out.WriteLine("TRACE> frames length = {0}", frames.Length);
                for (int i = 0; i < frames.Length; i++)
                {
                    string className = frames[i].GetMethod().DeclaringType.FullName;
                    string methodName = frames[i].GetMethod().Name;
                    if (className.Equals("Lucene.Net.Index.SegmentInfos"))
                    {
                        int foo = 2 + 3;
                    }
//if ("Lucene.Net.Index.SegmentInfos".Equals(frames[i].GetMethod().DeclaringType))
//if (frames[i].GetMethod().DeclaringType.ToString().StartsWith("Lucene.Net"))
//    System.Console.Out.WriteLine(frames[i].GetMethod().DeclaringType.ToString() + " " + frames[i].GetMethod().Name);

                    if ("Lucene.Net.Index.SegmentInfos".Equals(frames[i].GetMethod().DeclaringType.FullName) && "PrepareCommit".Equals(frames[i].GetMethod().Name))
                        isCommit = true;
                    if ("Lucene.Net.Store.MockRAMDirectory".Equals(frames[i].GetMethod().DeclaringType.FullName) && "DeleteFile".Equals(frames[i].GetMethod().Name))
                        isDelete = true;
                ...
                if (isCommit)
                {
                    ...
                    {
                        fail1 = true;
                        throw new System.Exception("now fail first");
                    }
                    else
                    {
                        fail2 = true;
        ...
        // LUCENE-1214
        [Test]
        public void TestExceptionsDuringCommit()
        {
            MockRAMDirectory dir = new MockRAMDirectory();
            ...
            {
                Assert.Fail("expected only System.Exception");
            }
            catch (System.Exception)
            {
                // Expected
        ...
        public void TestAllUnicodeChars()
        {
            ...
            for (int ch = 0; ch < 0x0010FFFF; ch++)
            {
                ...
                string s2 = System.Text.Encoding.UTF8.GetString(utf8.result, 0, utf8.length);
                ...
                byte[] b = System.Text.Encoding.UTF8.GetBytes(s1);
        ...
        public void TestRandomUnicodeStrings()
        {
            ...
            for (int iter = 0; iter < 100000; iter++)
            {
                ...
                if (!hasIllegal)
                {
                    byte[] b = System.Text.Encoding.UTF8.GetBytes(new string(buffer, 0, 20));
        ...
        // LUCENE-510
        [Test]
        public void TestIncrementalUnicodeStrings()
        {
            char[] buffer = new char[20];
            char[] expected = new char[20];
        ...
        // LUCENE-1274
        [Test]
        public void TestPrepareCommitNoChanges()
        {
            MockRAMDirectory dir = new MockRAMDirectory();
        ...
        private abstract class RunAddIndexesThreads
        {
            ...
            internal static int NUM_INIT_DOCS = 17;
            ...
            internal static int NUM_THREADS = 5;
            internal SupportClass.ThreadClass[] threads = new SupportClass.ThreadClass[NUM_THREADS];
            ...
            internal void LaunchThreads(int numIter)
            {
                ...
                for (int i = 0; i < NUM_THREADS; i++)
                {
                    threads[i] = new AddIndexesThread(numIter, this);
                }
            ...
            protected internal abstract void DoBody(int j, Directory[] dirs);
            protected internal abstract void Handle(System.Exception t);
        }

        private class AddIndexesThread : SupportClass.ThreadClass
        {
            private int numIter;
            private RunAddIndexesThreads enclosingInstance;

            public AddIndexesThread(int numIter, RunAddIndexesThreads enclosingInstance)
            {
        ...
        private class CommitAndAddIndexes : RunAddIndexesThreads
        {
            ...
            protected internal override void DoBody(int j, Directory[] dirs)
            {
                switch (j % 4)
                {
                    case 0:
        ...
        [Test]
        public void TestAddIndexesWithThreads()
        {
            ...
            Assert.AreEqual(100 + NUM_COPY * (3 * NUM_ITER / 4) * RunAddIndexesThreads.NUM_THREADS * RunAddIndexesThreads.NUM_INIT_DOCS, c.writer2.NumDocs());
            ...
            Assert.AreEqual(100 + NUM_COPY * (3 * NUM_ITER / 4) * RunAddIndexesThreads.NUM_THREADS * RunAddIndexesThreads.NUM_INIT_DOCS, reader.NumDocs());
            reader.Close();
        ...
        [Test]
        public void TestAddIndexesWithClose()
        {
            int NUM_COPY = 3;
        ...
        // LUCENE-1335: test simultaneous addIndexes & close
        [Test]
        public void TestAddIndexesWithCloseNoWait()
        {
        ...
        // LUCENE-1335: test simultaneous addIndexes & close
        [Test]
        public void TestAddIndexesWithRollback()
        {
        ...
        public class MockIndexWriter4 : IndexWriter
        {
            ...
            public MockIndexWriter4(Directory dir, Analyzer a, bool create, MaxFieldLength mfl)
                : base(dir, a, create, mfl)
            {
            }
            ...
            override protected bool TestPoint(string name)
            {
                if (doFail && name.Equals("rollback before checkpoint"))
                    throw new System.Exception("intentionally failing");
                return true;
            }
        }
        ...
        // LUCENE-1347
        [Test]
        public void TestRollbackExceptionHang()
        {
            MockRAMDirectory dir = new MockRAMDirectory();
            ...
            {
                w.Rollback();
                Assert.Fail("did not hit intentional System.Exception");
            }
            catch (System.Exception)
            {
                // expected
        ...
        // LUCENE-1374
        [Test]
        public void TestMergeCompressedFields()
        {
            System.IO.FileInfo indexDir = new System.IO.FileInfo(
                System.IO.Path.Combine(SupportClass.AppSettings.Get("tempDir", ""), "mergecompressedfields"));
            Directory dir = FSDirectory.GetDirectory(indexDir);
            try
            {
                for (int i = 0; i < 5; i++)
                ...
                try
                {
                    for (int i = 0; i < 5; i++)
                    {
                        ...
                        Assert.AreEqual("this is some data that will be compressed this this this", doc.GetField("test1").StringValue());
        ...
        public void TestOptimizeExceptions()
        {
            ...
            for (int i = 0; i < 200; i++)
            {
                ...
                ((ConcurrentMergeScheduler)w.GetMergeScheduler()).SetSuppressExceptions_ForNUnitTest();
                ...
                catch (System.IO.IOException ioe)
                {
                    if (ioe.InnerException == null)
                        Assert.Fail("optimize threw System.IO.IOException without root cause");
                }
                w.Close();
                dir.Close();
            }
