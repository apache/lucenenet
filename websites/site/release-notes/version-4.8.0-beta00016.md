...
* [#363](https://github.com/apache/lucenenet/pull/363), [#534](https://github.com/apache/lucenenet/pull/534) - `Lucene.Net.Replicator.IndexAndTaxonomyReplicationClientTest::TestConsistencyOnExceptions()` and `Lucene.Net.Replicator.IndexReplicationClientTest::TestConsistencyOnExceptions()` were failing due to exceptions being raised on the worker thread and missing locks, which have both been addressed.
