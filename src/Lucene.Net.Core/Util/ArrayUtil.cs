...
namespace Lucene.Net.Util
{
    ...
    public static class ArrayUtil
    {
        ...
        /// <summary>
        /// Returns a hash code for an array.
        /// </summary>
        /// <typeparam name="T">The element type for the array.</typeparam>
        /// <param name="array">The target array to create a hash code.</param>
        ...
        /// <exception cref="System.ArgumentException">Throws when <paramref name="minTargetSize"/> is less than zero.</exception>
        public static int Oversize(int minTargetSize, int bytesPerElement)
        {
            ...
            if (extra < 3)
            {
                ...
                // reallocate memory block is presumably relatively high, we grow
                // faster
                extra = 3;
            }
        ...
        {
            var max = int.MinValue / radix;
            var result = 0;
            for (var i = 0; i < len; i++)
            {
                var digit = (int)Char.GetNumericValue(chars[i + offset]);
                if (digit == -1)
                {
