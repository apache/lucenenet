...
namespace Lucene.Net.Search
{
    ...
    public class FuzzyTermsEnum : TermsEnum
    {
        ...
        protected internal virtual TermsEnum GetAutomatonEnum(int editDistance, BytesRef lastTerm)
        {
            ...
            {
                OutputCollector.AppendLine("fte:getautomatonenum editDistance=" + editDistance + ", lastTerm=" + lastTerm);
        ...
        private void BottomChanged(BytesRef lastTerm, bool init)
        {
            ...
            OutputCollector.AppendLine("    termAfter=" + termAfter + ", Bottom=" + Bottom + ", maxBoost=" + maxBoost);
            OutputCollector.AppendLine("    bottom >= maxBoost=" + (Bottom >= maxBoost) + ", bottom > maxBoost=" + (Bottom > maxBoost));
