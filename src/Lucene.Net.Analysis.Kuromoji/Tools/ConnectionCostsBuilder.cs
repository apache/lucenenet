    ...
    public class ConnectionCostsBuilder
    {
        ...
        public static ConnectionCostsWriter Build(string filename)
        {
            using (Stream inputStream = new FileStream(filename, FileMode.Open, FileAccess.Read))
            {
                ...
                if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(dimensions.Length == 2);
                ...
                if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(forwardSize > 0 && backwardSize > 0);
                ...
                while ((line = streamReader.ReadLine()) != null)
                {
                    ...
                    if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(fields.Length == 3);
