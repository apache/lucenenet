...
namespace Lucene.Net.Queryparser.Flexible.Messages
{
	...
	public class NLS
	{
		...
		protected internal static void InitializeMessages<_T0>(string bundleName, Type<_T0
			> clazz) where _T0:Lucene.Net.Queryparser.Flexible.Messages.NLS
		{
			try
			{
				Load(clazz);
		...
		private static void Load<_T0>(Type<_T0> clazz) where _T0:Lucene.Net.Queryparser.Flexible.Messages.NLS
		{
		...
		private static void LoadfieldValue<_T0>(FieldInfo field, bool isFieldAccessible, 
			Type<_T0> clazz) where _T0:Lucene.Net.Queryparser.Flexible.Messages.NLS
		{
		...
		private static void ValidateMessage<_T0>(string key, Type<_T0> clazz) where _T0:Lucene.Net.Queryparser.Flexible.Messages.NLS
		{
