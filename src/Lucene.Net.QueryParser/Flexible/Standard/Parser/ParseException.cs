...
namespace Lucene.Net.Queryparser.Flexible.Standard.Parser
{
	...
	public class ParseException : QueryNodeParseException
	{
		...
		public ParseException(Token currentTokenVal, int[][] expectedTokenSequencesVal, string
			[] tokenImageVal) : base(new MessageImpl(QueryParserMessages.INVALID_SYNTAX, Initialise
		...
		/// these constructors.
		/// </remarks>
		public ParseException() : base(new MessageImpl(QueryParserMessages.INVALID_SYNTAX
			, "Error"))
		{
		}
		...
		public ParseException(Message message) : base(message)
		{
		}
