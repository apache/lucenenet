...
namespace Lucene.Net.Queryparser.Flexible.Standard.Parser
{
	...
	public class Token
	{
		...
		/// this field.
		/// </remarks>
		public Lucene.Net.Queryparser.Flexible.Standard.Parser.Token next;
		...
		/// </remarks>
		public Lucene.Net.Queryparser.Flexible.Standard.Parser.Token specialToken;
		...
		/// </remarks>
		public static Lucene.Net.Queryparser.Flexible.Standard.Parser.Token NewToken
			(int ofKind, string image)
		{
			switch (ofKind)
			{
				default:
				{
					return new Lucene.Net.Queryparser.Flexible.Standard.Parser.Token(ofKind, image
						);
					break;
				}
			}
