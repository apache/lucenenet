...
namespace Lucene.Net.Queryparser.Flexible.Standard.Nodes
{
	...
	public class NumericRangeQueryNode : AbstractRangeQueryNode<NumericQueryNode>
	{
		...
		/// <see cref="NumericQueryNode">NumericQueryNode</see>
		/// as its bounds and
		/// <see cref="Lucene.Net.Queryparser.Flexible.Standard.Config.NumericConfig">Lucene.Net.Queryparser.Flexible.Standard.Config.NumericConfig
		/// 	</see>
		/// .
		/// </summary>
		...
		/// </param>
		/// <seealso cref="SetBounds(NumericQueryNode, NumericQueryNode, bool, bool, Lucene.Net.Queryparser.Flexible.Standard.Config.NumericConfig)
		/// 	">SetBounds(NumericQueryNode, NumericQueryNode, bool, bool, Lucene.Net.Queryparser.Flexible.Standard.Config.NumericConfig)
		/// 	</seealso>
