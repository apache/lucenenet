...
namespace Lucene.Net.Queryparser.Flexible.Standard.Config
{
	...
	public class NumericConfig
	{
		...
		/// 	</seealso>
		/// <seealso cref="SetType(Lucene.Net.Document.FieldType.NumericType)">SetType(Lucene.Net.Document.FieldType.NumericType)
		/// 	</seealso>
		...
		/// <seealso cref="Lucene.Net.Search.NumericRangeQuery{T}.GetPrecisionStep()">Lucene.Net.Search.NumericRangeQuery&lt;T&gt;.GetPrecisionStep()
		/// 	</seealso>
		...
		public override bool Equals(object obj)
		{
			...
			if (obj is Lucene.Net.Queryparser.Flexible.Standard.Config.NumericConfig)
			{
				Lucene.Net.Queryparser.Flexible.Standard.Config.NumericConfig other = (Lucene.Net.Queryparser.Flexible.Standard.Config.NumericConfig
					)obj;
