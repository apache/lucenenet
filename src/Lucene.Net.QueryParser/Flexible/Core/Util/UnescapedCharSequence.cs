...
namespace Lucene.Net.Queryparser.Flexible.Core.Util
{
	...
	public sealed class UnescapedCharSequence : CharSequence
	{
		...
		private UnescapedCharSequence(Lucene.Net.Queryparser.Flexible.Core.Util.UnescapedCharSequence
			 text)
		{
			this.chars = new char[text.Length];
			this.wasEscaped = new bool[text.Length];
		...
		public CharSequence SubSequence(int start, int end)
		{
			...
			return new Lucene.Net.Queryparser.Flexible.Core.Util.UnescapedCharSequence
		...
		{
			if (text is Lucene.Net.Queryparser.Flexible.Core.Util.UnescapedCharSequence)
			{
				return ((Lucene.Net.Queryparser.Flexible.Core.Util.UnescapedCharSequence)text
					).wasEscaped[index];
			}
			else
			{
		...
		public static CharSequence ToLowerCase(CharSequence text, CultureInfo locale)
		{
			if (text is Lucene.Net.Queryparser.Flexible.Core.Util.UnescapedCharSequence)
			{
				...
				bool[] wasEscaped = ((Lucene.Net.Queryparser.Flexible.Core.Util.UnescapedCharSequence
					)text).wasEscaped;
				return new Lucene.Net.Queryparser.Flexible.Core.Util.UnescapedCharSequence
