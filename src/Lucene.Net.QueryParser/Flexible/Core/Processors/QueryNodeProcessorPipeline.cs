...
namespace Lucene.Net.Queryparser.Flexible.Core.Processors
{
		...
		>
	{
		...
		/// <summary>
		/// For reference about this method check:
		/// <see cref="QueryNodeProcessor.Process(Lucene.Net.Queryparser.Flexible.Core.Nodes.QueryNode)
		/// 	">QueryNodeProcessor.Process(Lucene.Net.Queryparser.Flexible.Core.Nodes.QueryNode)
		/// 	</see>
		/// .
		/// </summary>
