...
namespace Lucene.Net.Queryparser.Flexible.Core.Messages
{
	/// <summary>Flexible Query Parser message bundle class</summary>
	public class QueryParserMessages : NLS
	{
		private static readonly string BUNDLE_NAME = typeof(Lucene.Net.Queryparser.Flexible.Core.Messages.QueryParserMessages
			).FullName;
		...
		static QueryParserMessages()
		{
			...
			// values
			NLS.InitializeMessages(BUNDLE_NAME, typeof(Lucene.Net.Queryparser.Flexible.Core.Messages.QueryParserMessages
				));
		}
