...
namespace Lucene.Net.Queryparser.Classic
{
	...
	public class Token
	{
		...
		/// this field.
		/// </remarks>
		public Lucene.Net.Queryparser.Classic.Token next;
		...
		/// </remarks>
		public Lucene.Net.Queryparser.Classic.Token specialToken;
		...
		/// </remarks>
		public static Lucene.Net.Queryparser.Classic.Token NewToken(int ofKind, string
			 image)
		{
			switch (ofKind)
			{
				default:
				{
					return new Lucene.Net.Queryparser.Classic.Token(ofKind, image);
					break;
				}
			}
		}

		public static Lucene.Net.Queryparser.Classic.Token NewToken(int ofKind)
		{
