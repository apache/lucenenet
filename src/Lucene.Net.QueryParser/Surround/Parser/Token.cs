...
namespace Lucene.Net.Queryparser.Surround.Parser
{
	...
	public class Token
	{
		...
		/// this field.
		/// </remarks>
		public Lucene.Net.Queryparser.Surround.Parser.Token next;
		...
		/// </remarks>
		public Lucene.Net.Queryparser.Surround.Parser.Token specialToken;
		...
		/// </remarks>
		public static Lucene.Net.Queryparser.Surround.Parser.Token NewToken(int ofKind
			, string image)
		{
			switch (ofKind)
			{
				default:
				{
					return new Lucene.Net.Queryparser.Surround.Parser.Token(ofKind, image);
					break;
				}
			}
		}
