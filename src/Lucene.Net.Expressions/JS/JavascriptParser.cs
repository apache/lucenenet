...
namespace Lucene.Net.Expressions.JS
{
	internal class JavascriptParser : Parser
	{
		...
		public JavascriptParser(CommonTokenStream input) : this(input, new RecognizerSharedState())
		{
		}

		public JavascriptParser(CommonTokenStream input, RecognizerSharedState state) : base(input
			, state)
		{
		}
			 ...
			 re)
		{
			...
			else
			{
				...
				{
					message = " extraneous " + GetReadableTokenString(re.Token) + " at position (" + 
		...
		public class Expression_return<TTree,TToken> : AstParserRuleReturnScope<TTree,TToken>
		{
		...
		public Expression_return<ITree,IToken> Expression()
		{
			var retval = new Expression_return<ITree,IToken> {Start = input.LT(1)};
        ...
        public class Conditional_return<TTree,TToken> : AstParserRuleReturnScope<TTree, TToken>
		{
			internal CommonTree tree;
		...
		public Conditional_return<ITree,IToken> Conditional()
		{
			var retval = new Conditional_return<ITree,IToken> {Start = input.LT(1)};
		    CommonTree root_0;
			IToken AT_COND_QUE4;
        ...
        public class Logical_or_return<TTree,TToken> : AstParserRuleReturnScope<TTree, TToken>
		{
			internal CommonTree tree;
		...
		public Logical_or_return<ITree,IToken> Logical_or()
		{
			var retval = new Logical_or_return<ITree,IToken> {Start = input.LT(1)};
		    CommonTree root_0;
			IToken AT_BOOL_OR9;
...
loop2_break: ;
        ...
        public class Logical_and_return<TTree,TToken> : AstParserRuleReturnScope<TTree, TToken>
		{
			internal CommonTree tree;
		...
		public Logical_and_return<ITree,IToken> Logical_and()
		{
			var retval = new Logical_and_return<ITree,IToken> {Start = input.LT(1)};
		    CommonTree root;
...
loop3_break: ;
        ...
        public class Bitwise_or_return<TTree,TToken> : AstParserRuleReturnScope<TTree, TToken>
		{
			internal CommonTree tree;
		...
		public Bitwise_or_return<ITree,IToken> Bitwise_or()
		{
			var retval = new Bitwise_or_return<ITree,IToken> {Start = input.LT(1)};
		    try
			{
			    CommonTree root = null;
			    {
...
loop4_break: ;
        ...
        public class Bitwise_xor_return<TTree,TToken> : AstParserRuleReturnScope<TTree, TToken>
		{
			internal CommonTree tree;
		...
		public Bitwise_xor_return<ITree,IToken> Bitwise_xor()
		{
			var retval = new Bitwise_xor_return<ITree,IToken> {Start = input.LT(1)};
		    try
			{
			    CommonTree root = null;
			    {
...
loop5_break: ;
        ...
        public class Bitwise_and_return<TTree, TToken> : AstParserRuleReturnScope<TTree, TToken>
		{
			internal CommonTree tree;
		...
		public Bitwise_and_return<ITree,IToken> Bitwise_and()
		{
			var retval = new Bitwise_and_return<ITree,IToken> {Start = input.LT(1)};
		    try
			{
			    CommonTree root = null;
			    {
...
loop6_break: ;
        ...
        public class Equality_return<TTree,TToken> : AstParserRuleReturnScope<TTree, TToken>
		{
			internal CommonTree tree;
		...
		public Equality_return<ITree,IToken> Equality()
		{
			var retval = new Equality_return<ITree,IToken> {Start = input.LT(1)};
...
loop7_break: ;
        ...
        public class Relational_return<TTree,TToken> : AstParserRuleReturnScope<TTree, TToken>
		{
			internal CommonTree tree;
		...
		public Relational_return<ITree,IToken> Relational()
		{
			var retval = new Relational_return<ITree,IToken> {Start = input.LT(1)};
...
loop8_break: ;
		...
		public class Shift_return<TTree,TToken> : AstParserRuleReturnScope<TTree, TToken>
		{
			internal CommonTree tree;
		...
		public Shift_return<ITree,IToken> Shift()
		{
			var retval = new Shift_return<ITree,IToken> {Start = input.LT(1)};
...
loop9_break: ;
        ...
        public class Additive_return<TTree, TToken> : AstParserRuleReturnScope<TTree, TToken>
		{
			internal CommonTree tree;
        ...
        public Additive_return<ITree, IToken> Additive()
		{
			var retval = new Additive_return<ITree,IToken> {Start = input.LT(1)};
...
loop10_break: ;
        ...
        public class Multiplicative_return<TTree, TToken> : AstParserRuleReturnScope<TTree, TToken>
		{
			internal CommonTree tree;
        ...
        public Multiplicative_return<ITree, IToken> Multiplicative()
		{
			var retval = new Multiplicative_return<ITree,IToken> {Start = input.LT(1)};
...
loop11_break: ;
        ...
        public class Unary_return<TTree, TToken> : AstParserRuleReturnScope<TTree, TToken>
		{
			internal CommonTree tree;
        ...
        public Unary_return<ITree, IToken> Unary()
		{
            var retval = new Unary_return<ITree, IToken> {Start = input.LT(1)};
            CommonTree root = null;
        ...
        public class Unary_operator_return<TTree, TToken> : AstParserRuleReturnScope<TTree, TToken>
		{
			internal CommonTree tree;
        ...
        public Unary_operator_return<ITree, IToken> Unary_operator()
		{
            var retval = new Unary_operator_return<ITree, IToken> {Start = input.LT(1)};
            CommonTree root = null;
        ...
        public class Postfix_return<TTree, TToken> : AstParserRuleReturnScope<TTree, TToken>
		{
			internal CommonTree tree;
        ...
        public Postfix_return<ITree, IToken> Postfix()
		{
            var retval = new Postfix_return<ITree, IToken> {Start = input.LT(1)};
            CommonTree root = null;
        ...
        public class Primary_return<TTree, TToken> : AstParserRuleReturnScope<TTree, TToken>
		{
			internal CommonTree tree;
        ...
        public Primary_return<ITree, IToken> Primary()
		{
            var retval = new Primary_return<ITree, IToken> {Start = input.LT(1)};
            CommonTree root = null;
        ...
        public class Arguments_return<TTree, TToken> : AstParserRuleReturnScope<TTree, TToken>
		{
			internal CommonTree tree;
        ...
        public Arguments_return<ITree, IToken> Arguments()
		{
            var retval = new Arguments_return<ITree, IToken> {Start = input.LT(1)};
            CommonTree root = null;
...
loop16_break: ;
        ...
        public class Numeric_return<TTree, TToken> : AstParserRuleReturnScope<TTree, TToken>
		{
			internal CommonTree tree;
        ...
        public Numeric_return<ITree, IToken> Numeric()
		{
            var retval = new Numeric_return<ITree, IToken> {Start = input.LT(1)};
