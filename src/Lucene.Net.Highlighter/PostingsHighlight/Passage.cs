...
namespace Lucene.Net.Search.PostingsHighlight
{
    ...
    public sealed class Passage
    {
        ...
        {
            if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(startOffset >= this.startOffset && startOffset <= this.endOffset);
            ...
            if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(matchStarts.Length == matchEnds.Length && matchEnds.Length == matchTerms.Length);
