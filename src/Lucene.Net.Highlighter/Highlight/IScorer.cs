...
namespace Lucene.Net.Search.Highlight
{
    ...
    public interface IScorer
    {
        ...
        /// <returns>
        /// either a <see cref="TokenStream"/> that the Highlighter should continue using (eg
        ...
        /// <summary>
        /// Called for each token in the current fragment. The <see cref="TokenStream"/> will
        /// increment the <see cref="TokenStream"/> passed to init on every call.
        /// </summary>
        /// <returns>a score which is passed to the <see cref="TokenStream"/> class to influence the
        /// mark-up of the text (this return value is NOT used to score the
        /// fragment)</returns> 
        float GetTokenScore();

        ///<summary>
        /// Called when the <see cref="TokenStream"/> has no more tokens for the current fragment -
