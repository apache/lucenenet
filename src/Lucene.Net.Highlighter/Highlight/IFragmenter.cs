...
namespace Lucene.Net.Search.Highlight
{
    ...
    public interface IFragmenter
    {
        ...
        /// interested in from <paramref name="tokenStream"/> and then access the values in <see cref="IsNewFragment()"/>.
        /// </summary>
        ...
        /// <see cref="TextFragment"/>. Every time this is called, the TokenStream
        /// passed to <see cref="Start(string, TokenStream)"/> will have been incremented.
        /// </summary>
        bool IsNewFragment();
    }
}