...
namespace Lucene.Net.Search.Highlight
{
	...
	public class Highlighter
	{
		...
		/// <see cref="GetBestFragment(Lucene.Net.Analysis.TokenStream, string)">GetBestFragment(Lucene.Net.Analysis.TokenStream, string)
		/// 	</see>
		/// </remarks>
		/// <param name="analyzer">
		...
		/// This is a convenience method that calls
		/// <see cref="GetBestFragments(Lucene.Net.Analysis.TokenStream, string, int)"
		/// 	>GetBestFragments(Lucene.Net.Analysis.TokenStream, string, int)</see>
		/// </remarks>
		/// <param name="analyzer">
		/// the analyzer that will be used to split <code>text</code>
		/// into chunks
