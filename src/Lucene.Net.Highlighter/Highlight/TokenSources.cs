...
namespace Lucene.Net.Search.Highlight
{
	...
	public class TokenSources
	{
		...
		/// 	</see>
		/// for the
		/// <see cref="Lucene.Net.Index.IndexableField">Lucene.Net.Index.IndexableField
		/// 	</see>
		/// on the
		/// <see cref="Lucene.Net.Document.Document">Lucene.Net.Document.Document
		/// 	</see>
		...
		public static TokenStream GetAnyTokenStream(IndexReader reader, int docId, string
			 field, Lucene.Net.Document.Document doc, Analyzer analyzer)
		{
			TokenStream ts = null;
		...
		public static TokenStream GetTokenStream(IndexReader reader, int docId, string field
			, Analyzer analyzer)
		{
			Lucene.Net.Document.Document doc = reader.Document(docId);
			return GetTokenStream(doc, field, analyzer);
		}

		public static TokenStream GetTokenStream(Lucene.Net.Document.Document doc, 
