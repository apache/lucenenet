...
namespace Lucene.Net.Facet
{
    ...
    public class TestDrillSideways : FacetTestCase
    {
        ...
        private class CollectorAnonymousInnerClassHelper : ICollector
        {
            ...
            {
                if (Debugging.AssertsEnabled && Debugging.ShouldAssert(doc > lastDocID)) Debugging.ThrowAssert();
                lastDocID = doc;
            }
        ...
        private class Counters
        {
            ...
            {
                if (Debugging.AssertsEnabled && Debugging.ShouldAssert(dims.Length == counts.Length)) Debugging.ThrowAssert();
                if (Debugging.AssertsEnabled && Debugging.ShouldAssert(dims2.Length == counts.Length)) Debugging.ThrowAssert();
