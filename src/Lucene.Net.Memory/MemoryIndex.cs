...
namespace Lucene.Net.Index.Memory
{
    ...
    public partial class MemoryIndex
    {
        ...
        internal MemoryIndex(bool storeOffsets, long maxReusedBytes)
        {
            ...
            if (Debugging.ShouldAssert((maxBufferedByteBlocks * ByteBlockPool.BYTE_BLOCK_SIZE) + (maxBufferedIntBlocks * Int32BlockPool.INT32_BLOCK_SIZE * RamUsageEstimator.NUM_BYTES_INT32) <= maxReusedBytes)) Debugging.ThrowAssert();
