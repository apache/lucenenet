...
namespace Lucene.Net.Codecs.Lucene40
{
    ...
    public class Lucene40PostingsReader : PostingsReaderBase
    {
        ...
        public override void DecodeTerm(long[] longs, DataInput @in, FieldInfo fieldInfo, BlockTermState termState, bool absolute)
        {
            ...
            */
            if (Debugging.ShouldAssert(termState2.freqOffset < freqIn.Length)) Debugging.ThrowAssert();
            ...
            if (termState2.DocFreq >= skipMinimum)
            {
                ...
                if (Debugging.ShouldAssert(termState2.freqOffset + termState2.skipOffset < freqIn.Length)) Debugging.ThrowAssert();
            }
            else
            {
                // undefined
        ...
        private abstract class SegmentDocsEnumBase : DocsEnum
        {
            ...
            internal virtual DocsEnum Reset(FieldInfo fieldInfo, StandardTermState termState)
            {
                ...
                if (Debugging.ShouldAssert(m_limit > 0)) Debugging.ThrowAssert();
                m_ord = 0;
                m_doc = -1;
                m_accum = 0;
        ...
        private sealed class AllDocsSegmentDocsEnum : SegmentDocsEnumBase
        {
            ...
            {
                this.outerInstance = outerInstance;
                if (Debugging.ShouldAssert(m_liveDocs == null)) Debugging.ThrowAssert();
            }
        ...
        private sealed class LiveDocsSegmentDocsEnum : SegmentDocsEnumBase
        {
            ...
            {
                this.outerInstance = outerInstance;
                if (Debugging.ShouldAssert(liveDocs != null)) Debugging.ThrowAssert();
            }
            ...
            public override int NextPosition()
            {
                ...
                while (posPendingCount > freq)
                {
                    ...
                    if (storePayloads)
                    {
                        ...
                        if (Debugging.ShouldAssert(payloadLength != -1)) Debugging.ThrowAssert();
                    }
