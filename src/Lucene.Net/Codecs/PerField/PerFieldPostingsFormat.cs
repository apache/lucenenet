    ...
    public abstract class PerFieldPostingsFormat : PostingsFormat
    {
        ...
        private class FieldsWriter : FieldsConsumer
        {
            ...
            public override TermsConsumer AddField(FieldInfo field)
            {
                ...
                if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(previousValue == null);
                ...
                else
                {
                    ...
                    if (Debugging.AssertsEnabled && Debugging.ShouldAssert(suffixes.ContainsKey(formatName))) Debugging.ThrowAssert();
                    ...
                    foreach (FieldInfo fi in readState.FieldInfos)
                    {
                        if (fi.IsIndexed)
                        {
                            ...
                            if (formatName != null)
                            {
                                ...
                                if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(suffix != null);
