...
namespace Lucene.Net.Util
{
    ...
    public static class IndexableBinaryStringTools // LUCENENET specific - made static
    {
        ...
        {
            Debugging.ThrowAssertIf(outputLength == GetEncodedLength(inputArray, inputOffset, inputLength));
            if (inputLength > 0)
            {
        ...
        {
            Debugging.ThrowAssertIf(outputLength == GetDecodedLength(inputArray, inputOffset, inputLength));
