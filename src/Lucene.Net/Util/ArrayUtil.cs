...
namespace Lucene.Net.Util
{
    ...
    public static class ArrayUtil // LUCENENET specific - made static
    {
        ...
        */
        ...
        {
            if (Debugging.AssertsEnabled && Debugging.ShouldAssert(minSize >= 0)) Debugging.ThrowAssert("size must be positive (got {0}): likely integer overflow?", minSize);
        ...
        {
            if (Debugging.AssertsEnabled && Debugging.ShouldAssert(minSize >= 0)) Debugging.ThrowAssert("size must be positive (got " + minSize + "): likely integer overflow?");
            if (array.Length < minSize)
            {
        ...
        {
            if (Debugging.AssertsEnabled && Debugging.ShouldAssert(targetSize >= 0)) Debugging.ThrowAssert("size must be positive (got {0}): likely integer overflow?", targetSize);
