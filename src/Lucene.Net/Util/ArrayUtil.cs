...
namespace Lucene.Net.Util
{
    ...
    public static class ArrayUtil // LUCENENET specific - made static
    {
        ...
        */
        ...
        {
            if (Debugging.ShouldAssert(minSize >= 0)) Debugging.ThrowAssert("size must be positive (got {0}): likely integer overflow?", minSize);
        ...
        {
            if (Debugging.ShouldAssert(minSize >= 0)) Debugging.ThrowAssert("size must be positive (got " + minSize + "): likely integer overflow?");
            if (array.Length < minSize)
            {
        ...
        {
            if (Debugging.ShouldAssert(targetSize >= 0)) Debugging.ThrowAssert("size must be positive (got {0}): likely integer overflow?", targetSize);
        ...
        */
        ...
        public static int[] ToInt32Array(ICollection<int?> ints)
        {
            ...
            // paranoia:
            if (Debugging.ShouldAssert(upto == result.Length)) Debugging.ThrowAssert();
