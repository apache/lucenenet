...
namespace Lucene.Net.Util
{
    ...
    public static class ArrayUtil // LUCENENET specific - made static
    {
        ...
        */
        ...
        {
            Debugging.Assert(() => minSize >= 0, () => "size must be positive (got " + minSize + "): likely integer overflow?");
        ...
        {
            Debugging.Assert(() => targetSize >= 0, () => "size must be positive (got " + targetSize + "): likely integer overflow?");
        ...
        */
        ...
        public static int[] ToInt32Array(ICollection<int?> ints)
        {
            ...
            // paranoia:
            Debugging.Assert(() => upto == result.Length);
