    ...
    public class Packed64 : PackedInt32s.MutableImpl
    {
        ...
        public override long Get(int index)
        {
            ...
            if (endBits <= 0) // Single block
            {
                ...
                if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(mod == og);
            ...
            if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(a == b);
        ...
        public override int Get(int index, long[] arr, int off, int len)
        {
            ...
            index += gotValues;
            len -= gotValues;
            if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(len >= 0);
        ...
        public override void Fill(int fromIndex, int toIndex, long val)
        {
            ...
            if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(fromIndex % nAlignedValues == 0);
            ...
            long[] nAlignedValuesBlocks;
            {
                ...
                if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(nAlignedBlocks <= nAlignedValuesBlocks.Length);
            }
