...
namespace Lucene.Net.Util.Packed
{
    ...
    public sealed class BlockPackedReaderIterator
    {
        ...
        public void Skip(long count)
        {
            ...
            if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(off == blockSize);
            ...
            // 3. skip last values
            if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(count < blockSize);
            Refill();
            ord += count;
            off += (int)count;
        }
        ...
        private void Refill()
        {
            ...
            if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(minEquals0 || minValue != 0);
