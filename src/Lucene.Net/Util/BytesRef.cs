...
namespace Lucene.Net.Util
{
...
#endif
    {
        ...
        {
            if (Debugging.ShouldAssert(Offset == 0)) Debugging.ThrowAssert(); // TODO broken if offset != 0
        ...
        {
            if (Debugging.ShouldAssert(other != null)) Debugging.ThrowAssert();
        ...
        {
            if (Debugging.ShouldAssert(Offset == 0)) Debugging.ThrowAssert(); // NOTE: senseless if offset != 0
        ...
        public int CompareTo(object other) // LUCENENET specific: Implemented IComparable for FieldComparer
        {
            ...
            if (Debugging.ShouldAssert(br != null)) Debugging.ThrowAssert();
