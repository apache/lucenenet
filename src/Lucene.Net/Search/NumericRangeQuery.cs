...
namespace Lucene.Net.Search
{
    ...
    ///
    /// <h3 id="precisionStepDesc">Precision Step</h3>
    ...
    /// <para>
    /// <!-- LUCENENET: the upstream Java docs rendered this formula as doc-files/nrq-formula-1.png,
    ///      which was never ported. The LaTeX source is:
    ///      \mathrm{termDictOverhead} = \sum\limits_{i=0}^{\mathrm{indexedTermsPerValue}-1} \frac{1}{2^{\mathrm{precisionStep}\cdot i}} -->
    /// &#160;&#160;<c>termDictOverhead = sum(i=0 to indexedTermsPerValue-1) of 1 / 2^(precisionStep * i)</c>
    /// </para>
    ...
    /// </para>
    /// <para>
    /// <!-- LUCENENET: the upstream Java docs rendered this formula as doc-files/nrq-formula-2.png,
    ///      which was never ported. The LaTeX source is:
    ...
    /// &#160;&#160;<c>maxQueryTerms = [ (indexedTermsPerValue - 1) * (2^precisionStep - 1) * 2 ] + (2^precisionStep - 1)</c>
    /// </para>
