...
namespace Lucene.Net.Search
{
    ...
    public static class Collector
    {
        ...
        private class AnonymousCollector : ICollector
        {
            ...
            {
                this.setScorer = setScorer ?? throw new ArgumentNullException("setScorer");
                this.collect = collect ?? throw new ArgumentNullException("collect");
                this.setNextReader = setNextReader ?? throw new ArgumentNullException("setNextReader");
                this.acceptsDocsOutOfOrder = acceptsDocsOutOfOrder ?? throw new ArgumentNullException("acceptsDocsOutOfOrder");
            }
