...
namespace Lucene.Net.Search
{
    ...
    public class ConstantScoreQuery : Query
    {
        ...
        public override Query Rewrite(IndexReader reader)
        {
            ...
            {
                if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(m_filter != null);
        ...
        protected class ConstantWeight : Weight
        {
            ...
            public override BulkScorer GetBulkScorer(AtomicReaderContext context, bool scoreDocsInOrder, IBits acceptDocs)
            {
                ...
                {
                    if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(outerInstance.m_query == null);
                    return base.GetBulkScorer(context, scoreDocsInOrder, acceptDocs);
                }
                else
                {
                    if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(outerInstance.m_query != null && innerWeight != null);
        ...
        protected internal class ConstantScorer : Scorer
        {
            ...
            {
                if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(docIdSetIterator.DocID != NO_MORE_DOCS);
                return theScore;
            }
