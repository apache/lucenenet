...
namespace Lucene.Net.Search
{
    ...
    public class TopDocs
    {
        ...
        private class ScoreMergeSortQueue : Util.PriorityQueue<ShardRef>
        {
            ...
            {
                if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(first != second);
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(first.HitIndex != second.HitIndex);
        ...
        public static TopDocs Merge(Sort sort, int start, int size, TopDocs[] shardHits)
        {
            ...
            else
            {
                ...
                {
                    if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(queue.Count > 0);
