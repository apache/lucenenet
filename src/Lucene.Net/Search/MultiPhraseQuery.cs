...
namespace Lucene.Net.Search
{
    ...
    public class MultiPhraseQuery : Query, IEnumerable<Term[]> // LUCENENET specific - implemented IEnumerable<Term[]>, which allows for use of collection initializer. See: https://stackoverflow.com/a/9195144
    {
        ...
        private class MultiPhraseWeight : Weight
        {
            ...
            {
                if (Debugging.ShouldAssert(outerInstance.termArrays.Count > 0)) Debugging.ThrowAssert();
                ...
                for (int pos = 0; pos < postingsFreqs.Length; pos++)
                {
                    ...
                    else
                    {
                        ...
                        if (postingsEnum == null)
                        {
                            ...
                            if (Debugging.ShouldAssert(termsEnum.Docs(liveDocs, null, DocsFlags.NONE) != null)) Debugging.ThrowAssert("termstate found but no term exists in reader");
