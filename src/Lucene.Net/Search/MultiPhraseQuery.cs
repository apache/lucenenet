                ...
                for (int pos = 0; pos < postingsFreqs.Length; pos++)
                {
                    ...
                    else
                    {
                        ...
                        if (postingsEnum == null)
                        {
                            ...
                            if (Debugging.AssertsEnabled && Debugging.ShouldAssert(termsEnum.Docs(liveDocs, null, DocsFlags.NONE) != null)) Debugging.ThrowAssert("termstate found but no term exists in reader");
