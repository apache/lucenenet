    ...
    public sealed class SegmentReader : AtomicReader
    {
        ...
        public SegmentReader(SegmentCommitInfo si, int termInfosIndexDivisor, IOContext context)
        {
            ...
            try
            {
                ...
                {
                    if (Debugging.AssertsEnabled && Debugging.ShouldAssert(si.DelCount == 0)) Debugging.ThrowAssert();
                    liveDocs = null;
                }
        ...
        public override NumericDocValues GetNumericDocValues(string field)
        {
            ...
            if (dvs == null)
            {
                ...
                if (Debugging.AssertsEnabled && Debugging.ShouldAssert(dvProducer != null)) Debugging.ThrowAssert();
