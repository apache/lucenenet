...
namespace Lucene.Net.Index
{
    ...
    internal sealed class DocumentsWriterPerThreadPool
    {
        ...
        /// </summary>
        public int NumThreadStatesActive // LUCENENET NOTE: Changed from getActiveThreadState() because the name wasn't clear
        {
            get
            {
        ...
        {
				Debug.Assert(NumThreadStatesActive < threadStates.Length);
