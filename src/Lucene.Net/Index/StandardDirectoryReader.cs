                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (Debugging.AssertsEnabled) Debugging.Assert(infos.Info(i).Info.Dir == newReaders[i].SegmentInfo.Info.Dir);
                            if (Debugging.AssertsEnabled) Debugging.Assert(infos.Info(i).HasDeletions || infos.Info(i).HasFieldUpdates);
