        ...
        public override bool MoveNext()
        {
            ...
            for (; ; )
            {
                ...
                if (doSeek)
                {
                    ...
                    if (Debugging.AssertsEnabled && Debugging.ShouldAssert(actualTerm == null || t == null || Comparer.Compare(t, actualTerm) > 0)) Debugging.ThrowAssert("curTerm={0} seekTerm={1}", actualTerm, t);
