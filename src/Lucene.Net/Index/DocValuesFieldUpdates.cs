            ...
            internal virtual DocValuesFieldUpdates NewUpdates(string field, DocValuesFieldUpdatesType type, int maxDoc)
            {
                switch (type)
                {
                    case DocValuesFieldUpdatesType.NUMERIC:
                        ...
                        if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(!numericDVUpdates.ContainsKey(field));
                    ...
                    case DocValuesFieldUpdatesType.BINARY:
                        ...
                        if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(!binaryDVUpdates.ContainsKey(field));
