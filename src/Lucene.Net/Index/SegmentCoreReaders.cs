    ...
    internal sealed class SegmentCoreReaders
    {
        ...
        internal SegmentCoreReaders(SegmentReader owner, Directory dir, SegmentCommitInfo si, IOContext context, int termsIndexDivisor)
        {
            ...
            try
            {
                ...
                if (Debugging.AssertsEnabled && Debugging.ShouldAssert(fields != null)) Debugging.ThrowAssert();
                ...
                if (fieldInfos.HasNorms)
                {
                    ...
                    if (Debugging.AssertsEnabled && Debugging.ShouldAssert(normsProducer != null)) Debugging.ThrowAssert();
                }
                else
                {
                    normsProducer = null;
