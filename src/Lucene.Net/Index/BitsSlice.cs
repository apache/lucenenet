...
namespace Lucene.Net.Index
{
    ...
    internal sealed class BitsSlice : IBits
    {
        ...
        public BitsSlice(IBits parent, ReaderSlice slice)
        {
            ...
            if (Debugging.AssertsEnabled && Debugging.ShouldAssert(length >= 0)) Debugging.ThrowAssert("length={0}", length);
        }
        ...
        public bool Get(int doc)
        {
            ...
            if (Debugging.AssertsEnabled && Debugging.ShouldAssert(doc < length)) Debugging.ThrowAssert("doc={0} length={1}", doc, length);
