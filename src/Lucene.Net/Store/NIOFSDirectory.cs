        ...
        protected class NIOFSIndexInput : BufferedIndexInput
        {
            ...
            protected override void ReadInternal(byte[] b, int offset, int len)
            {
                ...
                if (b == m_buffer && 0 == offset)
                {
                    ...
                    if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(byteBuf != null);
                    byteBuf.Clear();
                    byteBuf.Limit = len;
                    bb = byteBuf;
                }
                ...
                try
                {
                    while (readLength > 0)
                    {
                        ...
                        if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(bb.Remaining == toRead);
                    ...
                    if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(readLength == 0);
                }
