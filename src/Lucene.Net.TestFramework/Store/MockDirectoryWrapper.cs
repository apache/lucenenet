...
#pragma warning restore 168
                                ...
                                if (!Arrays.Equals(startFiles, endFiles))
                                {
                                    ...
                                    if (Debugging.AssertsEnabled && Debugging.ShouldAssert(false)) Debugging.ThrowAssert("unreferenced files: before delete:\n    {0}\n  after delete:\n    {1}", Arrays.ToString(startFiles), Arrays.ToString(endFiles) + extras);
                                }
                                ...
                                ir2.Dispose();
                                if (Debugging.AssertsEnabled && Debugging.ShouldAssert(numDocs1 == numDocs2)) Debugging.ThrowAssert("numDocs changed after opening/closing IW: before={0} after={1}", numDocs1, numDocs2);
                            }
                        }
                    }
