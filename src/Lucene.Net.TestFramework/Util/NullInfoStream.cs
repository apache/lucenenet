...
namespace Lucene.Net.Util
{
    ...
    public class NullInfoStream : InfoStream
    {
        ...
        {
            if (Debugging.AssertsEnabled && Debugging.ShouldAssert(component != null)) Debugging.ThrowAssert();
            if (Debugging.AssertsEnabled && Debugging.ShouldAssert(message != null)) Debugging.ThrowAssert();
        }
