...
#pragma warning restore 168
        ...
        {
            if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(leftTerms.Comparer == rightTerms.Comparer);
        ...
        {
            if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(leftReader.MaxDoc == rightReader.MaxDoc);
...
#pragma warning restore 612, 618
        ...
        {
            if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(leftReader.NumDeletedDocs == rightReader.NumDeletedDocs);
