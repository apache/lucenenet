...
namespace Lucene.Net.Codecs.Lucene3x
{
    ...
    internal class PreFlexRWNormsConsumer : DocValuesConsumer
    {
        ...
        {
            if (Debugging.AssertsEnabled && Debugging.ShouldAssert(field.Number > lastFieldNumber)) Debugging.ThrowAssert("writing norms fields out of order{0} -> {1}", lastFieldNumber, field.Number);
