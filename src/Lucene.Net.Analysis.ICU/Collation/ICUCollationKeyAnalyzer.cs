...
namespace Lucene.Net.Collation
{
    ...
    /// </summary>
    /// <remarks>
    /// Converts the token into its <see cref="SortKey"/>, and
    /// then encodes the <see cref="SortKey"/> either directly or with 
    ...
    /// <list type="bullet">
    ///     <item><description>As of 4.0, <see cref="SortKey"/>s are directly encoded as bytes. Previous
