...
namespace Lucene.Net.Codecs.SimpleText
{
    ...
    public class SimpleTextStoredFieldsReader : StoredFieldsReader
    {
        ...
        public override void VisitDocument(int n, StoredFieldVisitor visitor)
        {
            ...
            ReadLine();
            Debugging.ThrowAssertIf(StringHelper.StartsWith(_scratch, SimpleTextStoredFieldsWriter.NUM));
            var numFields = ParseInt32At(SimpleTextStoredFieldsWriter.NUM.Length);

            for (var i = 0; i < numFields; i++)
            {
                ReadLine();
                Debugging.ThrowAssertIf(StringHelper.StartsWith(_scratch, SimpleTextStoredFieldsWriter.FIELD));
                ...
                ReadLine();
                Debugging.ThrowAssertIf(StringHelper.StartsWith(_scratch, SimpleTextStoredFieldsWriter.NAME));
                ReadLine();
                Debugging.ThrowAssertIf(StringHelper.StartsWith(_scratch, SimpleTextStoredFieldsWriter.TYPE));
                ...
                switch (visitor.NeedsField(fieldInfo))
                {
                    ...
                    case StoredFieldVisitor.Status.NO:
                        ReadLine();
                        Debugging.ThrowAssertIf(StringHelper.StartsWith(_scratch, SimpleTextStoredFieldsWriter.VALUE));
                        break;
