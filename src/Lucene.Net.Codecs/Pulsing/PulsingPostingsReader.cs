    ...
    public class PulsingPostingsReader : PostingsReaderBase
    {
        ...
        internal class PulsingTermState : BlockTermState
        {
            ...
            public override object Clone()
            {
                ...
                {
                    if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(WrappedTermState != null);
        ...
        private class PulsingDocsEnum : DocsEnum
        {
            ...
            {
                if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(termState.PostingsSize != -1);
        ...
        private class PulsingDocsAndPositionsEnum : DocsAndPositionsEnum
        {
            ...
            {
                if (Debugging.AssertsEnabled) Debugging.ThrowAssertIf(_posPending > 0);
