    ...
    public class PulsingPostingsReader : PostingsReaderBase
    {
        ...
        internal class PulsingTermState : BlockTermState
        {
            ...
            public override object Clone()
            {
                ...
                {
                    if (Debugging.AssertsEnabled && Debugging.ShouldAssert(WrappedTermState != null)) Debugging.ThrowAssert();
        ...
        private class PulsingDocsEnum : DocsEnum
        {
            ...
            {
                if (Debugging.AssertsEnabled && Debugging.ShouldAssert(termState.PostingsSize != -1)) Debugging.ThrowAssert();
        ...
        private class PulsingDocsAndPositionsEnum : DocsAndPositionsEnum
        {
            ...
            {
                if (Debugging.AssertsEnabled && Debugging.ShouldAssert(_posPending > 0)) Debugging.ThrowAssert();
