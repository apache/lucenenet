...
namespace Org.Apache.Lucene.Search.Grouping
{
	...
	public class GroupingSearch
	{
		...
		public virtual Org.Apache.Lucene.Search.Grouping.GroupingSearch SetCachingInMB(double
		...
		/// <param name="cacheScores">Whether to cache the scores</param>
		/// <returns><code>this</code></returns>
		public virtual Org.Apache.Lucene.Search.Grouping.GroupingSearch SetCaching(int maxDocsToCache
			, bool cacheScores)
		{
		...
		/// <returns><code>this</code></returns>
		public virtual Org.Apache.Lucene.Search.Grouping.GroupingSearch DisableCaching()
		{
			this.maxCacheRAMMB = null;
			this.maxDocsToCache = null;
			return this;
		...
		/// Defaults to
		/// <see cref="Org.Apache.Lucene.Search.Sort.RELEVANCE">Org.Apache.Lucene.Search.Sort.RELEVANCE
		/// 	</see>
		/// .
		/// </remarks>
		/// <param name="groupSort">The sort for the groups.</param>
		/// <returns><code>this</code></returns>
		public virtual Org.Apache.Lucene.Search.Grouping.GroupingSearch SetGroupSort(Sort
			 groupSort)
		{
		...
		/// <returns><code>this</code></returns>
		public virtual Org.Apache.Lucene.Search.Grouping.GroupingSearch SetSortWithinGroup
		...
		/// <returns><code>this</code></returns>
		public virtual Org.Apache.Lucene.Search.Grouping.GroupingSearch SetGroupDocsOffset
			(int groupDocsOffset)
		{
		...
		/// <returns><code>this</code></returns>
		public virtual Org.Apache.Lucene.Search.Grouping.GroupingSearch SetGroupDocsLimit
			(int groupDocsLimit)
		{
		...
		/// 	</param>
		/// <returns><code>this</code></returns>
		public virtual Org.Apache.Lucene.Search.Grouping.GroupingSearch SetFillSortFields
			(bool fillSortFields)
		{
		...
		/// <returns><code>this</code></returns>
		public virtual Org.Apache.Lucene.Search.Grouping.GroupingSearch SetIncludeScores(
			bool includeScores)
		{
		...
		/// 	</param>
		/// <returns><code>this</code></returns>
		public virtual Org.Apache.Lucene.Search.Grouping.GroupingSearch SetIncludeMaxScore
		...
		/// <returns><code>this</code></returns>
		public virtual Org.Apache.Lucene.Search.Grouping.GroupingSearch SetAllGroups(bool
			 allGroups)
		{
		...
		/// 	</param>
		/// <returns><code>this</code></returns>
		public virtual Org.Apache.Lucene.Search.Grouping.GroupingSearch SetAllGroupHeads(
			bool allGroupHeads)
		{
		...
		/// <returns><code>this</code></returns>
		public virtual Org.Apache.Lucene.Search.Grouping.GroupingSearch SetInitialSize(int
			 initialSize)
		{
