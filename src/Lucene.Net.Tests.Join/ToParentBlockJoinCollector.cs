...
namespace Org.Apache.Lucene.Search.Join
{
	...
	/// 	>Org.Apache.Lucene.Index.IndexWriter.AddDocuments(Sharpen.Iterable&lt;T&gt;)</see>
	/// or
	/// <see cref="Org.Apache.Lucene.Index.IndexWriter.UpdateDocuments(Org.Apache.Lucene.Index.Term, Sharpen.Iterable{T})
	/// 	">Org.Apache.Lucene.Index.IndexWriter.UpdateDocuments(Org.Apache.Lucene.Index.Term, Sharpen.Iterable&lt;T&gt;)
	/// 	</see>
	...
	/// using
	/// <see cref="GetTopGroups(ToParentBlockJoinQuery, Org.Apache.Lucene.Search.Sort, int, int, int, bool)
	/// 	">GetTopGroups(ToParentBlockJoinQuery, Org.Apache.Lucene.Search.Sort, int, int, int, bool)
	/// 	</see>
	/// .  Ie,
	...
	public class ToParentBlockJoinCollector : Collector
	{
		...
		/// <see cref="ToParentBlockJoinCollector(Org.Apache.Lucene.Search.Sort, int, bool, bool)
		/// 	">
		/// on
		/// construction
		/// </see>
