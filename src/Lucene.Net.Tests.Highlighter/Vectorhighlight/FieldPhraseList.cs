...
namespace Org.Apache.Lucene.Search.Vectorhighlight
{
	...
	public class FieldPhraseList
	{
		...
		public FieldPhraseList(Org.Apache.Lucene.Search.Vectorhighlight.FieldPhraseList[]
			 toMerge)
		{
			...
			int index = 0;
			foreach (Org.Apache.Lucene.Search.Vectorhighlight.FieldPhraseList fplToMerge in toMerge)
			{
