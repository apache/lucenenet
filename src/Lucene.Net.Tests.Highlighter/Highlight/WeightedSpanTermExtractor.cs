...
namespace Org.Apache.Lucene.Search.Highlight
{
	...
	/// based on whether
	/// <see cref="Org.Apache.Lucene.Index.Term">Org.Apache.Lucene.Index.Term</see>
	/// s from the
	/// <see cref="Org.Apache.Lucene.Search.Query">Org.Apache.Lucene.Search.Query</see>
	...
	public class WeightedSpanTermExtractor
	{
			...
			> terms, SpanQuery spanQuery)
		{
			...
			foreach (string field_1 in fieldNames)
			{
				...
				Org.Apache.Lucene.Search.Spans.Spans spans = q.GetSpans(context, acceptDocs, termContexts
					);
		...
		internal sealed class DelegatingAtomicReader : FilterAtomicReader
		{
			...
			/// <exception cref="System.IO.IOException"></exception>
			public override Org.Apache.Lucene.Index.Fields Fields()
			{
			...
			{
				public _FilterFields_388(Org.Apache.Lucene.Index.Fields baseArg1) : base(baseArg1
					)
				{
				}
