...
#pragma warning restore 168
        ...
        internal class LoadFieldValuesPostingsHighlighter : WholeBreakIteratorPostingsHighlighter
        {
            ...
            {
                if (Debugging.AssertsEnabled && Debugging.ShouldAssert(fields.Length == 1)) Debugging.ThrowAssert();
                if (Debugging.AssertsEnabled && Debugging.ShouldAssert(docids.Length == 1)) Debugging.ThrowAssert();
        ...
        internal class GetMultiValuedSeparatorPostingsHighlighter : PostingsHighlighter
        {
            ...
            {
                Debugging.ThrowAssertIf(field.Equals("body", StringComparison.Ordinal));
                return '\u2029';
            }
        }
