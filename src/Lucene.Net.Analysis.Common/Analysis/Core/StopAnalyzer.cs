...
namespace Lucene.Net.Analysis.Core
{
	...
	public sealed class StopAnalyzer : StopwordAnalyzerBase
	{
		...
		static StopAnalyzer()
		{
			IList<string> stopWords = Arrays.AsList(
			...
			StopAnalyzer.ENGLISH_STOP_WORDS_SET = CharArraySet.UnmodifiableSet(stopSet);
		}
		...
		public StopAnalyzer(LuceneVersion matchVersion) : this(matchVersion, StopAnalyzer.ENGLISH_STOP_WORDS_SET)
		{
		}
		...
		{
			Tokenizer source = new LowerCaseTokenizer(this.matchVersion, reader);
