...
#pragma warning restore 612, 618
        ...
        private static Step ParseStep(TextReader r, string header)
        {
            ...
            //if (Debugging.AssertsEnabled && Debugging.ShouldAssert(headerPattern.GetGroupNumbers().Length == 4)) Debugging.ThrowAssert(); // Not possible to read the number of groups that matched in .NET
