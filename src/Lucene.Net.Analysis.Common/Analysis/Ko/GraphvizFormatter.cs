...
namespace Lucene.Net.Analysis.Ko
{
    ...
    private const string BOS_LABEL = "BOS";
        ...
        internal void OnBacktrace(
            KoreanTokenizer tok,
            KoreanTokenizer.WrappedPositionArray positions,
            int lastBackTracePos,
            KoreanTokenizer.Position endPosData,
            int fromIDX,
            char[] fragment,
            bool isEnd)
        {
