...
namespace Lucene.Net.Analysis.Util
{
    ...
    public class StemmerUtil
    {
        ...
        {
            if (Debugging.AssertsEnabled && Debugging.ShouldAssert(pos < len)) Debugging.ThrowAssert();
        ...
        {
            if (Debugging.AssertsEnabled && Debugging.ShouldAssert(pos + nChars <= len)) Debugging.ThrowAssert();
