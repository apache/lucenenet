...
4.  The collation strength used - see {@link java.text.Collator#setStrength(int)}
 ...
 `CollationKey`s generated by `java.text.Collator`s are not compatible with those generated by ICU Collators. Specifically, if you use `CollationKeyAnalyzer` to generate index terms, do not use `ICUCollationKeyAnalyzer` on the query side, or vice versa.