...
namespace Lucene.Net.Search.Join
{
	internal class TermsIncludingScoreQuery : Query
	{
		...
		public override Query Rewrite(IndexReader reader)
		{
			...
			{
				Query rewritten = new Lucene.Net.Search.Join.TermsIncludingScoreQuery(field
		...
		public override bool Equals(object obj)
		{
			...
			Lucene.Net.Search.Join.TermsIncludingScoreQuery other = (Lucene.Net.Search.Join.TermsIncludingScoreQuery
				)obj;
