...
namespace Lucene.Net.Search.Join
{
	...
	public class ToChildBlockJoinQuery : Query
	{
		...
		private class ToChildBlockJoinWeight : Weight
		{
			...
			/// <exception cref="System.IO.IOException"></exception>
			public override Lucene.Net.Search.Scorer Scorer(AtomicReaderContext readerContext
				, Bits acceptDocs)
			{
				Lucene.Net.Search.Scorer parentScorer = parentWeight.Scorer(readerContext, 
					null);
