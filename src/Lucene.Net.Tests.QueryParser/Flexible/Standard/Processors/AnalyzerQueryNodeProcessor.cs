...
namespace Org.Apache.Lucene.Queryparser.Flexible.Standard.Processors
{
	...
	/// <see cref="Org.Apache.Lucene.Queryparser.Flexible.Standard.Config.StandardQueryConfigHandler.ConfigurationKeys.ANALYZER
	/// 	">Org.Apache.Lucene.Queryparser.Flexible.Standard.Config.StandardQueryConfigHandler.ConfigurationKeys.ANALYZER
	/// 	</see>
	/// is defined in the
	...
	/// <see cref="Org.Apache.Lucene.Queryparser.Flexible.Core.Nodes.NoTokenFoundQueryNode
	/// 	">Org.Apache.Lucene.Queryparser.Flexible.Core.Nodes.NoTokenFoundQueryNode</see>
	/// object
	/// is returned. <br/>
	/// </summary>
	/// <seealso cref="Org.Apache.Lucene.Queryparser.Flexible.Standard.Config.StandardQueryConfigHandler.ConfigurationKeys.ANALYZER
	/// 	">Org.Apache.Lucene.Queryparser.Flexible.Standard.Config.StandardQueryConfigHandler.ConfigurationKeys.ANALYZER
	/// 	</seealso>
	/// <seealso cref="Org.Apache.Lucene.Analysis.Analyzer">Org.Apache.Lucene.Analysis.Analyzer
	/// 	</seealso>
	/// <seealso cref="Org.Apache.Lucene.Analysis.TokenStream">Org.Apache.Lucene.Analysis.TokenStream
	/// 	</seealso>
