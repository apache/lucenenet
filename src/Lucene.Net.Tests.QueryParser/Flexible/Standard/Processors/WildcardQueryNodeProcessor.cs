...
namespace Org.Apache.Lucene.Queryparser.Flexible.Standard.Processors
{
	...
	/// value. <br/>
	/// </summary>
	/// <seealso cref="Org.Apache.Lucene.Search.PrefixQuery">Org.Apache.Lucene.Search.PrefixQuery
	/// 	</seealso>
	/// <seealso cref="Org.Apache.Lucene.Queryparser.Flexible.Standard.Nodes.PrefixWildcardQueryNode
	/// 	">Org.Apache.Lucene.Queryparser.Flexible.Standard.Nodes.PrefixWildcardQueryNode</seealso>
