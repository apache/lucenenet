...
namespace Org.Apache.Lucene.Queryparser.Flexible.Standard.Processors
{
	...
	/// <see cref="Org.Apache.Lucene.Queryparser.Flexible.Standard.Config.StandardQueryConfigHandler.ConfigurationKeys.MULTI_FIELDS
	/// 	">Org.Apache.Lucene.Queryparser.Flexible.Standard.Config.StandardQueryConfigHandler.ConfigurationKeys.MULTI_FIELDS
	/// 	</see>
	/// defined in the
	...
	/// is returned. <br/>
	/// </remarks>
	/// <seealso cref="Org.Apache.Lucene.Queryparser.Flexible.Standard.Config.StandardQueryConfigHandler.ConfigurationKeys.MULTI_FIELDS
	/// 	">Org.Apache.Lucene.Queryparser.Flexible.Standard.Config.StandardQueryConfigHandler.ConfigurationKeys.MULTI_FIELDS
	/// 	</seealso>
