...
namespace Org.Apache.Lucene.Queryparser.Flexible.Standard
{
	...
	/// is a
	/// <see cref="Org.Apache.Lucene.Queryparser.Flexible.Standard.Config.StandardQueryConfigHandler
	...
	/// <see cref="Org.Apache.Lucene.Queryparser.Flexible.Standard.Builders.StandardQueryTreeBuilder
	...
	/// <seealso cref="Org.Apache.Lucene.Queryparser.Flexible.Standard.Config.StandardQueryConfigHandler
	/// 	">Org.Apache.Lucene.Queryparser.Flexible.Standard.Config.StandardQueryConfigHandler
	/// 	</seealso>
	/// <seealso cref="Org.Apache.Lucene.Queryparser.Flexible.Standard.Parser.StandardSyntaxParser
	/// 	">Org.Apache.Lucene.Queryparser.Flexible.Standard.Parser.StandardSyntaxParser</seealso>
	/// <seealso cref="Org.Apache.Lucene.Queryparser.Flexible.Standard.Processors.StandardQueryNodeProcessorPipeline
	/// 	">Org.Apache.Lucene.Queryparser.Flexible.Standard.Processors.StandardQueryNodeProcessorPipeline
	/// 	</seealso>
	/// <seealso cref="Org.Apache.Lucene.Queryparser.Flexible.Standard.Builders.StandardQueryTreeBuilder
	/// 	">Org.Apache.Lucene.Queryparser.Flexible.Standard.Builders.StandardQueryTreeBuilder
	/// 	</seealso>
	public class StandardQueryParser : QueryParserHelper, CommonQueryParserConfiguration
	{
		...
		/// <summary>
		/// Overrides
		/// <see cref="Org.Apache.Lucene.Queryparser.Flexible.Core.QueryParserHelper.Parse(string, string)
		/// 	">Org.Apache.Lucene.Queryparser.Flexible.Core.QueryParserHelper.Parse(string, string)
		/// 	</see>
		/// so it casts the
		/// return object to
		...
		/// <exception cref="Org.Apache.Lucene.Queryparser.Flexible.Core.QueryNodeException">if something wrong happens along the three phases
		/// 	</exception>
		...
		/// 	</see>
		/// or
		/// <see cref="Org.Apache.Lucene.Queryparser.Flexible.Standard.Config.StandardQueryConfigHandler.Operator.OR
		/// 	">Org.Apache.Lucene.Queryparser.Flexible.Standard.Config.StandardQueryConfigHandler.Operator.OR
		/// 	</see>
		/// .
		/// </summary>
