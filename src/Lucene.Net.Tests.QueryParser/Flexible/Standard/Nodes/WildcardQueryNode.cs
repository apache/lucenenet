...
namespace Org.Apache.Lucene.Queryparser.Flexible.Standard.Nodes
{
	...
	public class WildcardQueryNode : FieldQueryNode
	{
		...
		{
			Org.Apache.Lucene.Queryparser.Flexible.Standard.Nodes.WildcardQueryNode clone = (
				Org.Apache.Lucene.Queryparser.Flexible.Standard.Nodes.WildcardQueryNode)base.CloneTree
				();
			// nothing to do here
			return clone;
		}
