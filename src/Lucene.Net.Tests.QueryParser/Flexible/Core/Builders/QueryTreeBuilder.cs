...
namespace Org.Apache.Lucene.Queryparser.Flexible.Core.Builders
{
	...
	public class QueryTreeBuilder : QueryBuilder
	{
		...
		/// produced from their own associated builder.
		/// </remarks>
		public static readonly string QUERY_TREE_BUILDER_TAGID = typeof(Org.Apache.Lucene.Queryparser.Flexible.Core.Builders.QueryTreeBuilder
			).FullName;
		...
		private void Process(QueryNode node)
		{
			if (node != null)
			{
				...
				if (!(builder is Org.Apache.Lucene.Queryparser.Flexible.Core.Builders.QueryTreeBuilder
					))
				{
		...
		/// <see cref="Org.Apache.Lucene.Queryparser.Flexible.Core.QueryNodeException">Org.Apache.Lucene.Queryparser.Flexible.Core.QueryNodeException
		/// 	</see>
