...
namespace Org.Apache.Lucene.Queryparser.Flexible.Core.Config
{
	...
	/// <see cref="Org.Apache.Lucene.Queryparser.Flexible.Core.Processors.QueryNodeProcessor
	/// 	">Org.Apache.Lucene.Queryparser.Flexible.Core.Processors.QueryNodeProcessor</see>
	/// objects.
