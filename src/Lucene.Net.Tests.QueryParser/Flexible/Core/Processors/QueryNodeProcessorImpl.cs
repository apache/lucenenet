...
namespace Org.Apache.Lucene.Queryparser.Flexible.Core.Processors
{
	...
	/// <see cref="PreProcessNode(Org.Apache.Lucene.Queryparser.Flexible.Core.Nodes.QueryNode)
	/// 	">PreProcessNode(Org.Apache.Lucene.Queryparser.Flexible.Core.Nodes.QueryNode)</see>
	/// is invoked. After a node's children are
	/// processed,
	/// <see cref="PostProcessNode(Org.Apache.Lucene.Queryparser.Flexible.Core.Nodes.QueryNode)
	/// 	">PostProcessNode(Org.Apache.Lucene.Queryparser.Flexible.Core.Nodes.QueryNode)</see>
	...
	public abstract class QueryNodeProcessorImpl : QueryNodeProcessor
	{
		...
		/// <exception cref="Org.Apache.Lucene.Queryparser.Flexible.Core.QueryNodeException">if something goes wrong during the query node processing
		/// 	</exception>
