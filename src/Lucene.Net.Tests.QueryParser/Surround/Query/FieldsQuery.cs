...
namespace Org.Apache.Lucene.Queryparser.Surround.Query
{
	...
	public class FieldsQuery : SrndQuery
	{
		...
		public virtual Org.Apache.Lucene.Search.Query MakeLuceneQueryNoBoost(BasicQueryFactory
			 qf)
		{
			...
			else
			{
				...
				{
					qc = q.Clone();
					queries.AddItem(new Org.Apache.Lucene.Queryparser.Surround.Query.FieldsQuery(qc, 
						fni.Next(), fieldOp));
				}
