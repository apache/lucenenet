...
namespace Org.Apache.Lucene.Queryparser.Surround.Query
{
	...
	public abstract class SimpleTerm : SrndQuery, DistanceSubQuery, Comparable<Org.Apache.Lucene.Queryparser.Surround.Query.SimpleTerm
		>
	{
		...
		public virtual int CompareTo(Org.Apache.Lucene.Queryparser.Surround.Query.SimpleTerm
			 ost)
		{
		...
		/// in
		/// <see cref="VisitMatchingTerm(Org.Apache.Lucene.Index.Term)">VisitMatchingTerm(Org.Apache.Lucene.Index.Term)
		/// 	</see>
		/// </summary>
