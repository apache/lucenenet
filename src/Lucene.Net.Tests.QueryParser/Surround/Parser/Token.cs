...
namespace Org.Apache.Lucene.Queryparser.Surround.Parser
{
	...
	public class Token
	{
		...
		/// this field.
		/// </remarks>
		public Org.Apache.Lucene.Queryparser.Surround.Parser.Token next;
		...
		/// </remarks>
		public Org.Apache.Lucene.Queryparser.Surround.Parser.Token specialToken;
		...
		/// </remarks>
		public static Org.Apache.Lucene.Queryparser.Surround.Parser.Token NewToken(int ofKind
			, string image)
		{
			switch (ofKind)
			{
				default:
				{
					return new Org.Apache.Lucene.Queryparser.Surround.Parser.Token(ofKind, image);
					break;
				}
			}
		}
