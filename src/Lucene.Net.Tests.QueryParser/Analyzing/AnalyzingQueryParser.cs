...
namespace Org.Apache.Lucene.Queryparser.Analyzing
{
	/// <summary>
	...
	public class AnalyzingQueryParser : QueryParser
	{
		...
		/// <exception cref="Org.Apache.Lucene.Queryparser.Classic.ParseException">when analysis returns other than one output token
		/// 	</exception>
