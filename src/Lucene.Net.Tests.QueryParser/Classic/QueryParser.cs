...
namespace Org.Apache.Lucene.Queryparser.Classic
{
	...
	/// has to be set,
	/// if you want to use
	/// <see cref="Org.Apache.Lucene.Document.DateTools">Org.Apache.Lucene.Document.DateTools
	/// 	</see>
	/// for date conversion.
	/// </p>
	/// <p>
	...
	/// using
	/// <see cref="QueryParserBase.SetDateResolution(Org.Apache.Lucene.Document.DateTools.Resolution)
	/// 	">QueryParserBase.SetDateResolution(Org.Apache.Lucene.Document.DateTools.Resolution)
	/// 	</see>
	/// or
	/// <see cref="QueryParserBase.SetDateResolution(string, Org.Apache.Lucene.Document.DateTools.Resolution)
	/// 	">QueryParserBase.SetDateResolution(string, Org.Apache.Lucene.Document.DateTools.Resolution)
	/// 	</see>
	/// . The former
	...
	/// <see cref="Org.Apache.Lucene.Util.Version">Org.Apache.Lucene.Util.Version</see>
	...
	public class QueryParser : QueryParserBase, QueryParserConstants
	{
		...
		/// <exception cref="Org.Apache.Lucene.Queryparser.Classic.ParseException"></exception>
		public sealed override Org.Apache.Lucene.Search.Query TopLevelQuery(string field)
		{
		...
		/// <exception cref="Org.Apache.Lucene.Queryparser.Classic.ParseException"></exception>
		public Org.Apache.Lucene.Search.Query Query(string field)
		{
			IList<BooleanClause> clauses = new AList<BooleanClause>();
			Org.Apache.Lucene.Search.Query q;
			Org.Apache.Lucene.Search.Query firstQuery = null;
			int conj;
			int mods;
			mods = Modifiers();
			q = Clause(field);
...
label_1_break: ;
		...
		/// <exception cref="Org.Apache.Lucene.Queryparser.Classic.ParseException"></exception>
		public Org.Apache.Lucene.Search.Query Clause(string field)
		{
			Org.Apache.Lucene.Search.Query q;
		...
		/// <exception cref="Org.Apache.Lucene.Queryparser.Classic.ParseException"></exception>
		public Org.Apache.Lucene.Search.Query Term(string field)
		{
			Token term;
			Token boost = null;
