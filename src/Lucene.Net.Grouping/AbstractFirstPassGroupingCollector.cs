    ...
    public abstract class AbstractFirstPassGroupingCollector<TGroupValue> : IAbstractFirstPassGroupingCollector<TGroupValue>
    {
        ...
        public virtual void Collect(int doc)
        {
            ...
            if (!groupMap.TryGetValue(groupValue, out group))
            {
                ...
                if (Debugging.ShouldAssert(m_orderedGroups.Count == topNGroups - 1)) Debugging.ThrowAssert();
                ...
                if (Debugging.ShouldAssert(m_orderedGroups.Count == topNGroups)) Debugging.ThrowAssert();
        ...
        private void BuildSortedSet()
        {
            ...
            if (Debugging.ShouldAssert(m_orderedGroups.Count > 0)) Debugging.ThrowAssert();
