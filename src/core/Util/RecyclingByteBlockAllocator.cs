...
namespace Lucene.Net.Util
{
	...
	public sealed class RecyclingByteBlockAllocator : ByteBlockPool.Allocator
	{
	  ...
	  public RecyclingByteBlockAllocator(int blockSize, int maxBufferedBlocks, Counter bytesUsed) : base(blockSize)
	  {
	  ...
	  /// <param name="maxBufferedBlocks">
	  ///          maximum number of buffered byte block </param>
	  public RecyclingByteBlockAllocator(int blockSize, int maxBufferedBlocks) : this(blockSize, maxBufferedBlocks, Counter.NewCounter(false))
	  {
	  }
	  ...
	  /// 
	  /// </summary>
	  public RecyclingByteBlockAllocator() : this(ByteBlockPool.BYTE_BLOCK_SIZE, 64, Counter.NewCounter(false))
	  {
	  }
