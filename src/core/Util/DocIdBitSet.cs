...
namespace Lucene.Net.Util
{
	...
	{
	  private readonly BitArray BitSet_Renamed;

	  public DocIdBitSet(BitArray bitSet)
	  {
		this.BitSet_Renamed = bitSet;
	  }

	  public override DocIdSetIterator Iterator()
	  {
		return new DocIdBitSetIterator(BitSet_Renamed);
	  }
	  ...
	  public virtual BitArray BitSet
	  {
		  get
		  {
			return this.BitSet_Renamed;
		  }
	  }

	  public override bool Get(int index)
	  {
		return BitSet_Renamed.Get(index);
	  }

	  public override int Length()
	  {
		// the size may not be correct...
		return BitSet_Renamed.Count;
	  }
