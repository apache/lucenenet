...
namespace Lucene.Net.Util
{
	...
	public sealed class BytesRefHash
	{
	  ...
	  /// </summary>
	  public BytesRefHash() : this(new ByteBlockPool(new DirectAllocator()))
	  {
	  }
	  ...
	  /// </summary>
	  public BytesRefHash(ByteBlockPool pool) : this(pool, DEFAULT_CAPACITY, new DirectBytesStartArray(DEFAULT_CAPACITY))
	  {
	  }
