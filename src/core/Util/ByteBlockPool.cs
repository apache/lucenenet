...
namespace Lucene.Net.Util
{
	...
	public sealed class ByteBlockPool
	{
	  ...
	  public sealed class DirectAllocator : Allocator
	  {
		...
		public DirectAllocator() : this(BYTE_BLOCK_SIZE)
		{
		}

		public DirectAllocator(int blockSize) : base(blockSize)
		{
		}
	  ...
	  public class DirectTrackingAllocator : Allocator
	  {
		...
		public DirectTrackingAllocator(Counter bytesUsed) : this(BYTE_BLOCK_SIZE, bytesUsed)
		{
		}

		public DirectTrackingAllocator(int blockSize, Counter bytesUsed) : base(blockSize)
		{
