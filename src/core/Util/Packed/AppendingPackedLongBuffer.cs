...
namespace Lucene.Net.Util.Packed
{
	...
	public sealed class AppendingPackedLongBuffer : AbstractAppendingLongBuffer
	{
	  ...
	  public AppendingPackedLongBuffer(int initialPageCount, int pageSize, float acceptableOverheadRatio) : base(initialPageCount, pageSize, acceptableOverheadRatio)
	  {
	  }
	  ...
	  /// pageSize=1024
	  /// </summary>
	  public AppendingPackedLongBuffer(float acceptableOverheadRatio) : this(16, 1024, acceptableOverheadRatio)
	  {
	  }
