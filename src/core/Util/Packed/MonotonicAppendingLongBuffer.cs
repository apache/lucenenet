...
namespace Lucene.Net.Util.Packed
{
	...
	public sealed class MonotonicAppendingLongBuffer : AbstractAppendingLongBuffer
	{
	  ...
	  public MonotonicAppendingLongBuffer(int initialPageCount, int pageSize, float acceptableOverheadRatio) : base(initialPageCount, pageSize, acceptableOverheadRatio)
	  {
	  ...
	  /// </summary>
	  public MonotonicAppendingLongBuffer() : this(16, 1024, PackedInts.DEFAULT)
	  {
	  }
	  ...
	  /// pageSize=1024
	  /// </summary>
	  public MonotonicAppendingLongBuffer(float acceptableOverheadRatio) : this(16, 1024, acceptableOverheadRatio)
	  {
	  }
