...
namespace Lucene.Net.Util.Packed
{
	...
	public class EliasFanoEncoder
	{
	  ...
	  public EliasFanoEncoder(long numValues, long upperBound, long indexInterval)
	  {
		...
		long numHighBitsClear = (int)((uint)((this.UpperBound > 0) ? this.UpperBound : 0) >> this.NumLowBits);
	  ...
	  /// </summary>
	  public EliasFanoEncoder(long numValues, long upperBound) : this(numValues, upperBound, DEFAULT_INDEX_INTERVAL)
	  {
	  }
