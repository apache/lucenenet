...
namespace Lucene.Net.Util.Packed
{
	...
	public sealed class AppendingDeltaPackedLongBuffer : AbstractAppendingLongBuffer
	{
	  ...
	  public AppendingDeltaPackedLongBuffer(int initialPageCount, int pageSize, float acceptableOverheadRatio) : base(initialPageCount, pageSize, acceptableOverheadRatio)
	  {
	  ...
	  /// pageSize=1024
	  /// </summary>
	  public AppendingDeltaPackedLongBuffer(float acceptableOverheadRatio) : this(16, 1024, acceptableOverheadRatio)
	  {
	  }
