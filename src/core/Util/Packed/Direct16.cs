...
namespace Lucene.Net.Util.Packed
{
	...
	internal sealed class Direct16 : PackedInts.MutableImpl
	{
	  ...
	  internal Direct16(int valueCount) : base(valueCount, 16)
	  {
		Values = new short[valueCount];
	  }

	  internal Direct16(int packedIntsVersion, DataInput @in, int valueCount) : this(valueCount)
	  {
...
//ORIGINAL LINE: final int remaining = (int)(PackedInts.Format.PACKED.byteCount(packedIntsVersion, valueCount, 16) - 2L * valueCount);
