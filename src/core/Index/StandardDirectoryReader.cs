...
namespace Lucene.Net.Index
{
	...
	internal sealed class StandardDirectoryReader : DirectoryReader
	{
	  ...
	  internal StandardDirectoryReader(Directory directory, AtomicReader[] readers, IndexWriter writer, SegmentInfos sis, int termInfosIndexDivisor, bool applyAllDeletes) : base(directory, readers)
	  {
		this.Writer = writer;
	  ...
	  private class FindSegmentsFileAnonymousInnerClassHelper : SegmentInfos.FindSegmentsFile
	  {
		  ...
		  public FindSegmentsFileAnonymousInnerClassHelper(Directory directory, int termInfosIndexDivisor) : base(directory)
		  {
...
//ORIGINAL LINE: final String segmentsFile = segmentInfos.getSegmentsFileName();
	  ...
	  private class FindSegmentsFileAnonymousInnerClassHelper2 : SegmentInfos.FindSegmentsFile
	  {
		  ...
		  public FindSegmentsFileAnonymousInnerClassHelper2(StandardDirectoryReader outerInstance, Directory directory) : base(directory)
		  {
