...
namespace Lucene.Net.Index
{
	...
	public class ParallelCompositeReader : BaseCompositeReader<IndexReader>
	{
	  ...
	  /// </summary>
	  public ParallelCompositeReader(params CompositeReader[] readers) : this(true, readers)
	  {
	  }
	  ...
	  ///  readers. 
	  /// </summary>
	  public ParallelCompositeReader(bool closeSubReaders, params CompositeReader[] readers) : this(closeSubReaders, readers, readers)
	  {
	  }
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final boolean[] childAtomic = new boolean[noSubs];
		  bool[] childAtomic = new bool[noSubs];
		  for (int i = 0; i < noSubs; i++)
		  {
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final IndexReader r = firstSubReaders.get(i);
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final IndexReader[] subReaders = new IndexReader[noSubs];
		  ...
		  for (int i = 0; i < subReaders.Length; i++)
		  {
			...
			{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final AtomicReader[] atomicSubs = new AtomicReader[readers.length];
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final CompositeReader[] compositeSubs = new CompositeReader[readers.length];
...
//ORIGINAL LINE: final CompositeReader[] storedSubs = new CompositeReader[storedFieldsReaders.length];
	  ...
	  {
		  public ParallelAtomicReaderAnonymousInnerClassHelper(Lucene.Net.Index.AtomicReader[] atomicSubs, Lucene.Net.Index.AtomicReader[] storedSubs) : base(true, atomicSubs, storedSubs)
		  {
		  }
	  ...
	  {
		  public ParallelCompositeReaderAnonymousInnerClassHelper(Lucene.Net.Index.CompositeReader[] compositeSubs, Lucene.Net.Index.CompositeReader[] storedSubs) : base(true, compositeSubs, storedSubs)
		  {
		  }
	  ...
	  private static void Validate(CompositeReader[] readers, int maxDoc, int[] childMaxDoc, bool[] childAtomic)
	  {
		...
		{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final CompositeReader reader = readers[i];
...
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final int noSubs = subs.size();
		  ...
		  {
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final IndexReader r = subs.get(subIDX);
