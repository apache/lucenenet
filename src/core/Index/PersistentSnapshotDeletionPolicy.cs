...
namespace Lucene.Net.Index
{
	...
	public class PersistentSnapshotDeletionPolicy : SnapshotDeletionPolicy
	{
	  ...
	  ///          information. </param>
	  public PersistentSnapshotDeletionPolicy(IndexDeletionPolicy primary, Directory dir) : this(primary, dir, OpenMode.CREATE_OR_APPEND)
	  {
	  }
	  ...
	  public PersistentSnapshotDeletionPolicy(IndexDeletionPolicy primary, Directory dir, OpenMode mode) : base(primary)
	  {
