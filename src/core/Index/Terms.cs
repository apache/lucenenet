...
namespace Lucene.Net.Index
{
	...
	public abstract class Terms
	{
	  ...
	  private class AutomatonTermsEnumAnonymousInnerClassHelper : AutomatonTermsEnum
	  {
		  ...
		  public AutomatonTermsEnumAnonymousInnerClassHelper(Terms outerInstance, Lucene.Net.Index.TermsEnum iterator, CompiledAutomaton compiled, BytesRef startTerm) : base(iterator, compiled)
		  {
