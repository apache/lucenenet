...
namespace Lucene.Net.Index
{
	...
	public sealed class AtomicReaderContext : IndexReaderContext
	{
	  ...
	  private readonly AtomicReader Reader_Renamed;
	  private readonly IList<AtomicReaderContext> Leaves_Renamed;

	  /// <summary>
	  /// Creates a new <seealso cref="AtomicReaderContext"/> 
	  /// </summary>
	  internal AtomicReaderContext(CompositeReaderContext parent, AtomicReader reader, int ord, int docBase, int leafOrd, int leafDocBase) : base(parent, ord, docBase)
	  {
		this.Ord = leafOrd;
