namespace Lucene.Net.Index
{
	...
	public class SegmentReadState
	{
	  ...
	  public SegmentReadState(Directory dir, SegmentInfo info, FieldInfos fieldInfos, IOContext context, int termsIndexDivisor) : this(dir, info, fieldInfos, context, termsIndexDivisor, "")
	  {
	  }
