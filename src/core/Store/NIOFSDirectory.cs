...
namespace Lucene.Net.Store
{
    ...
    public class NIOFSDirectory : FSDirectory
    {
        ...
        public override IndexInput OpenInput(string name, IOContext context)
        {
            ...
            path.Create();
            FileStream fc = new FileStream(path.FullName, FileMode.Open, FileAccess.ReadWrite, FileShare.Read);//FileChannel.open(path.toPath(), StandardOpenOption.READ);
        ...
        public override IndexInputSlicer CreateSlicer(string name, IOContext context)
        {
            ...
            FileInfo path = new FileInfo(Path.Combine(Directory.FullName, name));
            FileStream fc = new FileStream(path.FullName, FileMode.Open, FileAccess.ReadWrite, FileShare.Read);
