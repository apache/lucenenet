...
//ORIGINAL LINE: final FileEntry entry = entries.get(id);
	  ...
	  private class IndexInputSlicerAnonymousInnerClassHelper : IndexInputSlicer
	  {
		  ...
		  public IndexInputSlicerAnonymousInnerClassHelper(CompoundFileDirectory outerInstance, Lucene.Net.Store.CompoundFileDirectory.FileEntry entry) : base(outerInstance)
		  {
