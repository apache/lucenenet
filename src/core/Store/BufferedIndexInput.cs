...
namespace Lucene.Net.Store
{
	...
	public abstract class BufferedIndexInput : IndexInput
	{
	  ...
	  public BufferedIndexInput(string resourceDesc) : this(resourceDesc, BUFFER_SIZE)
	  {
	  }

	  public BufferedIndexInput(string resourceDesc, IOContext context) : this(resourceDesc, BufferSize(context))
	  {
	  }
