...
namespace Lucene.Net.Search
{
	...
	public abstract class CachingCollector : Collector
	{
	  ...
	  private sealed class CachedScorer : Scorer
	  {
		...
		internal CachedScorer() : base(null)
		{
		}
	  ...
	  private sealed class ScoreCachingCollector : CachingCollector
	  {
		...
		internal ScoreCachingCollector(Collector other, double maxRAMMB) : base(other, maxRAMMB, true)
		{
		...
		internal ScoreCachingCollector(Collector other, int maxDocsToCache) : base(other, maxDocsToCache)
		{
	  ...
	  private sealed class NoScoreCachingCollector : CachingCollector
	  {
		...
		internal NoScoreCachingCollector(Collector other, double maxRAMMB) : base(other, maxRAMMB, false)
		{
		}

		internal NoScoreCachingCollector(Collector other, int maxDocsToCache) : base(other, maxDocsToCache)
		{
		}
