...
namespace Lucene.Net.Search
{
	...
	public class FieldDoc : ScoreDoc
	{
	  ...
	  public FieldDoc(int doc, float score, object[] fields) : base(doc, score)
	  {
		this.Fields = fields;
	  }
	  ...
	  /// <summary>
	  /// Expert: Creates one of these objects with the given sort information. </summary>
	  public FieldDoc(int doc, float score, object[] fields, int shardIndex) : base(doc, score, shardIndex)
	  {
		this.Fields = fields;
	  }
