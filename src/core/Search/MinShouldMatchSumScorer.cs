...
namespace Lucene.Net.Search
{
	...
	internal class MinShouldMatchSumScorer : Scorer
	{
	  ...
	  public MinShouldMatchSumScorer(Weight weight, IList<Scorer> subScorers, int minimumNrMatchers) : base(weight)
	  {
	  ...
	  /// </summary>
	  public MinShouldMatchSumScorer(Weight weight, IList<Scorer> subScorers) : this(weight, subScorers, 1)
	  {
	  }
