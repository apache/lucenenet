...
namespace Lucene.Net.Search.Spans
{
	...
	public class SpanPayloadCheckQuery : SpanPositionCheckQuery
	{
	  ...
	  public SpanPayloadCheckQuery(SpanQuery match, ICollection<sbyte[]> payloadToMatch) : base(match)
	  {
...
//JAVA TO C# CONVERTER TODO TASK: Java iterators are only converted within the context of 'while' and 'for' loops:
	  ...
	  {
		SpanPayloadCheckQuery result = new SpanPayloadCheckQuery((SpanQuery) Match_Renamed.Clone(), PayloadToMatch);
		result.Boost = Boost;
		return result;
	  }
	  ...
	  public override bool Equals(object o)
	  {
		...
		return this.PayloadToMatch.Equals(other.PayloadToMatch) && this.Match_Renamed.Equals(other.Match_Renamed) && this.Boost == other.Boost;
	  }
