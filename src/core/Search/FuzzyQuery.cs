...
namespace Lucene.Net.Search
{
	...
	public class FuzzyQuery : MultiTermQuery
	{
	  ...
	  public FuzzyQuery(Term term, int maxEdits, int prefixLength, int maxExpansions, bool transpositions) : base(term.Field())
	  {
	  ...
	  /// </summary>
	  public FuzzyQuery(Term term, int maxEdits) : this(term, maxEdits, DefaultPrefixLength)
	  {
	  }
	  ...
	  /// </summary>
	  public FuzzyQuery(Term term) : this(term, DefaultMaxEdits)
	  {
	  }
