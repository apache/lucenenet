...
namespace Lucene.Net.Search.Payloads
{
	...
	public class PayloadNearQuery : SpanNearQuery
	{
	  ...
	  public class PayloadNearSpanWeight : SpanWeight
	  {
		...
		public PayloadNearSpanWeight(PayloadNearQuery outerInstance, SpanQuery query, IndexSearcher searcher) : base(query, searcher)
		{
	  ...
	  public class PayloadNearSpanScorer : SpanScorer
	  {
		...
		protected internal PayloadNearSpanScorer(PayloadNearQuery outerInstance, Spans spans, Weight weight, Similarity similarity, Similarity.SimScorer docScorer) : base(spans, weight, docScorer)
		{
			this.OuterInstance = outerInstance;
		  this.Spans = spans;
		}
