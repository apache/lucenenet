namespace Lucene.Net.Search.Payloads
{
	...
	public class PayloadTermQuery : SpanTermQuery
	{
	  ...
	  protected internal class PayloadTermWeight : SpanWeight
	  {
		...
		public PayloadTermWeight(PayloadTermQuery outerInstance, PayloadTermQuery query, IndexSearcher searcher) : base(query, searcher)
		{
		...
		protected internal class PayloadTermSpanScorer : SpanScorer
		{
		  ...
		  public PayloadTermSpanScorer(PayloadTermQuery.PayloadTermWeight outerInstance, TermSpans spans, Weight weight, Similarity.SimScorer docScorer) : base(spans, weight, docScorer)
		  {
			  this.OuterInstance = outerInstance;
			TermSpans = spans;
		  }
