namespace Lucene.Net.Search
{
	...
	public class TermRangeFilter : MultiTermQueryWrapperFilter<TermRangeQuery>
	{
	  ...
	  public TermRangeFilter(string fieldName, BytesRef lowerTerm, BytesRef upperTerm, bool includeLower, bool includeUpper) : base(new TermRangeQuery(fieldName, lowerTerm, upperTerm, includeLower, includeUpper))
	  {
	  }
