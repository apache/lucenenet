...
namespace Lucene.Net.Search
{
	...
	public abstract class DocTermOrdsRangeFilter : Filter
	{
	  ...
	  private class DocTermOrdsRangeFilterAnonymousInnerClassHelper : DocTermOrdsRangeFilter
	  {
		  ...
		  public DocTermOrdsRangeFilterAnonymousInnerClassHelper(string field, BytesRef lowerVal, BytesRef upperVal, bool includeLower, bool includeUpper) : base(field, lowerVal, upperVal, includeLower, includeUpper)
		  {
			  this.Field = field;
