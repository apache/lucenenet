namespace Lucene.Net.Search
{
	...
	/// 
	/// </summary>
	public sealed class NumericRangeFilter<T> : MultiTermQueryWrapperFilter<NumericRangeQuery<T>> where T : Number
	{

	  private NumericRangeFilter(NumericRangeQuery<T> query) : base(query)
	  {
	  }
