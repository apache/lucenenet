namespace Lucene.Net.Document
{
	...
	using IndexSearcher = Lucene.Net.Search.IndexSearcher; // javadocs
	...
	public sealed class StoredField : Field
	{
	  ...
	  public StoredField(string name, sbyte[] value) : base(name, value, TYPE)
	  {
	  }
	  ...
	  /// <exception cref="IllegalArgumentException"> if the field name is null. </exception>
	  public StoredField(string name, sbyte[] value, int offset, int length) : base(name, value, offset, length, TYPE)
	  {
	  }
	  ...
	  /// <exception cref="IllegalArgumentException"> if the field name is null. </exception>
	  public StoredField(string name, BytesRef value) : base(name, value, TYPE)
	  {
	  }
	  ...
	  public StoredField(string name, string value) : base(name, value, TYPE)
	  {
	  }
	  ...
	  /// <exception cref="IllegalArgumentException"> if the field name is null. </exception>
	  public StoredField(string name, int value) : base(name, TYPE)
	  {
		FieldsData = value;
	  }
	  ...
	  /// <exception cref="IllegalArgumentException"> if the field name is null. </exception>
	  public StoredField(string name, long value) : base(name, TYPE)
	  {
		FieldsData = value;
	  }
	  ...
	  /// <exception cref="IllegalArgumentException"> if the field name is null. </exception>
	  public StoredField(string name, double value) : base(name, TYPE)
	  {
		FieldsData = value;
	  }
	}
