...
namespace Lucene.Net.Analysis.Tokenattributes
{
	...
	public class CharTermAttributeImpl : AttributeImpl, CharTermAttribute, TermToBytesRefAttribute, ICloneable
	{
	  ...
	  public override void CopyBuffer(char[] buffer, int offset, int length)
	  {
	  ...
	  public override char[] ResizeBuffer(int newSize)
	  {
...
//ORIGINAL LINE: final char[] newCharBuffer = new char[Lucene.Net.Util.ArrayUtil.oversize(newSize, Lucene.Net.Util.RamUsageEstimator.NUM_BYTES_CHAR)];
	  ...
	  public override CharTermAttribute SetLength(int length)
	  {
	  ...
	  public override CharTermAttribute SetEmpty()
	  {
		TermLength = 0;
		return this;
	  }
      ...
      */
	  ...
	  public override CharTermAttribute Append(string csq, int start, int end)
	  {
          if (csq == null)
              return AppendNull();
	  ...
	  public override CharTermAttribute Append(char c)
	  {
		ResizeBuffer(TermLength + 1)[TermLength++] = c;
		return this;
	  }

	  public override CharTermAttribute Append(string s)
	  {
          return Append(s, 0, s == null ? 0 : s.Length);
	  }

	  public override CharTermAttribute Append(StringBuilder s)
	  {
	  ...
	  public override CharTermAttribute Append(CharTermAttribute ta)
	  {
	  ...
	  public override CharTermAttributeImpl Clone()
	  {
		CharTermAttributeImpl t = (CharTermAttributeImpl)base.Clone();
		// Do a deep clone
	  ...
	  public override bool Equals(object other)
	  {
		...
		{
//JAVA TO C# CONVERTER WARNING: The original Java variable was marked 'final':
//ORIGINAL LINE: final CharTermAttributeImpl o = ((CharTermAttributeImpl) other);
