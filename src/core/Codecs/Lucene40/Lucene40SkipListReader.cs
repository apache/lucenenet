...
namespace Lucene.Net.Codecs.Lucene40
{
	...
	public class Lucene40SkipListReader : MultiLevelSkipListReader
	{
	  ...
	  public Lucene40SkipListReader(IndexInput skipStream, int maxSkipLevels, int skipInterval) : base(skipStream, maxSkipLevels, skipInterval)
	  {
	  ...
	  public virtual void Init(long skipPointer, long freqBasePointer, long proxBasePointer, int df, bool storesPayloads, bool storesOffsets)
	  {
		...
		Arrays.fill(FreqPointer_Renamed, freqBasePointer);
		Arrays.fill(ProxPointer_Renamed, proxBasePointer);
		Arrays.fill(PayloadLength_Renamed, 0);
		Arrays.fill(OffsetLength_Renamed, 0);
	  }
