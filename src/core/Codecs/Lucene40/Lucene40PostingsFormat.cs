...
namespace Lucene.Net.Codecs.Lucene40
{
	...
	using IndexOptions = Lucene.Net.Index.FieldInfo.IndexOptions_e; // javadocs
	...
	using Lucene.Net.Util.Fst; // javadocs
	...
	public class Lucene40PostingsFormat : PostingsFormat
	{
	  ...
	  ///  settings. 
	  /// </summary>
	  public Lucene40PostingsFormat() : this(BlockTreeTermsWriter.DEFAULT_MIN_BLOCK_SIZE, BlockTreeTermsWriter.DEFAULT_MAX_BLOCK_SIZE)
	  {
	  }
	  ...
	  private Lucene40PostingsFormat(int minBlockSize, int maxBlockSize) : base("Lucene40")
	  {
