...
namespace Lucene.Net.Codecs
{
	...
	public abstract class MultiLevelSkipListReader : IDisposable
	{
	  ...
	  ///  the same. 
	  /// </summary>
	  protected internal MultiLevelSkipListReader(IndexInput skipStream, int maxSkipLevels, int skipInterval) : this(skipStream, maxSkipLevels, skipInterval, skipInterval)
	  {
	  }
