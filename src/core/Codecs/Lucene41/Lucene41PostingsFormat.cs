...
namespace Lucene.Net.Codecs.Lucene41
{
	...
	public sealed class Lucene41PostingsFormat : PostingsFormat
	{
	  ...
	  ///  settings. 
	  /// </summary>
	  public Lucene41PostingsFormat() : this(BlockTreeTermsWriter.DEFAULT_MIN_BLOCK_SIZE, BlockTreeTermsWriter.DEFAULT_MAX_BLOCK_SIZE)
	  {
	  }
	  ...
	  public Lucene41PostingsFormat(int minTermBlockSize, int maxTermBlockSize) : base("Lucene41")
	  {
