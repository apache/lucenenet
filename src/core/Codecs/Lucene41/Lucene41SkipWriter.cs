namespace Lucene.Net.Codecs.Lucene41
{
	...
	internal sealed class Lucene41SkipWriter : MultiLevelSkipListWriter
	{
	  ...
	  public Lucene41SkipWriter(int maxSkipLevels, int blockSize, int docCount, IndexOutput docOut, IndexOutput posOut, IndexOutput payOut) : base(blockSize, 8, maxSkipLevels, docCount)
	  {
		this.DocOut = docOut;
		this.PosOut = posOut;
		this.PayOut = payOut;
