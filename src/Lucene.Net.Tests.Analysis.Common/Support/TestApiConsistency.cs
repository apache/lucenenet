...
namespace Lucene.Net.Analysis
{
    ...
    public class TestApiConsistency : ApiScanTestBase
    {
        ...
        {
            base.TestPrivateFieldNames(typeFromTargetAssembly, @"Snowball\.Ext\..+Stemmer|Miscellaneous\.Scandinavian.+Filter\.[AO]E_se|En\.KStemmer\.MaxWordLen|CharArraySet\.DefaultSetSize|Enumerator\.(?:KeyValuePair|DictEntry)");
        }
