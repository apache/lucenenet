...
namespace Lucene.Net
{
    ...
    public class TestApiConsistency : ApiScanTestBase
    {
        ...
        {
            base.TestForMembersAcceptingOrReturningListOrDictionary(typeFromTargetAssembly, @"Configuration\.ConfigurationBuilder");
        }
    }
}
