...
namespace Lucene.Net.Facet
{
    ...
    public sealed class DrillDownQuery : Query
    {
        ...
        internal DrillDownQuery(FacetsConfig config, Filter filter, DrillDownQuery other)
        {
            ...
            if (Debugging.AssertsEnabled && Debugging.ShouldAssert(clauses.Length == 1 + other.drillDownDims.Count)) Debugging.ThrowAssert("{0} vs {1}", clauses.Length, (1 + other.drillDownDims.Count));
