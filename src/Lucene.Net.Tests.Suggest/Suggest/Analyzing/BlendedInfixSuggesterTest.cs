        ...
        */
        ...
        public void TestBlendedSort()
        {
            ...
            BlendedInfixSuggester suggester = new BlendedInfixSuggester(TEST_VERSION_CURRENT, NewFSDirectory(tempDir), a, a,
                                                                        ...
                                                                        BlendedInfixSuggester.DEFAULT_NUM_FACTOR);     //TODO: add extra false param at version 4.11.0
        ...
        public void TestBlendingType()
        {
            ...
            suggester = new BlendedInfixSuggester(TEST_VERSION_CURRENT, NewFSDirectory(tempDir), a, a,
                                                  AnalyzingInfixSuggester.DEFAULT_MIN_PREFIX_CHARS,
                                                  BlendedInfixSuggester.BlenderType.POSITION_RECIPROCAL, 1);    //TODO: add extra false param at version 4.11.0
            suggester.Build(new InputArrayEnumerator(keys));
        ...
        public void TestRequiresMore()
        {
            ...
            suggester = new BlendedInfixSuggester(TEST_VERSION_CURRENT, NewFSDirectory(tempDir), a, a,
                                                  AnalyzingInfixSuggester.DEFAULT_MIN_PREFIX_CHARS,
                                                  BlendedInfixSuggester.BlenderType.POSITION_RECIPROCAL, 2);     //TODO: add extra false param at version 4.11.0
            suggester.Build(new InputArrayEnumerator(keys));
