...
namespace Lucene.Net.Search.Suggest.Analyzing
{
    ...
    public class AnalyzingSuggesterTest : LuceneTestCase
    {
        ...
        public void TestKeywordIterator()
        {
            IEnumerable<Input> keys = Shuffle(
                new Input("foo", 50),
                new Input("bar", 10),
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestKeywordWithPayloadsIterator()
        {
            IEnumerable<Input> keys = Shuffle(
                new Input("foo", 50, new BytesRef("hello")),
                new Input("bar", 10, new BytesRef("goodbye")),
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestRandomRealisticKeysIterator()
        {
            LineFileDocs lineFile = new LineFileDocs(Random);
            IDictionary<string, long> mapping = new JCG.Dictionary<string, long>();
            List<Input> keys = new List<Input>();
       ...
       */
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestNoSepsIterator()
        {
            Input[]
            keys = new Input[] {
                new Input("ab cd", 0),
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestGraphDupsIterator()
        {
            Analyzer analyzer = new TestGraphDupsAnalyzer(this);
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestInputPathRequiredIterator()
        {
        ...
        */
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestExactFirstIterator()
        {
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestNonExactFirstIterator()
        {
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestMaxSurfaceFormsPerAnalyzedFormIterator()
        {
            Analyzer a = new MockAnalyzer(Random);
            AnalyzingSuggester suggester = new AnalyzingSuggester(a, a, 0, 2, -1, true);
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestQueueExhaustionIterator()
        {
            Analyzer a = new MockAnalyzer(Random);
            AnalyzingSuggester suggester = new AnalyzingSuggester(a, a, SuggesterOptions.EXACT_FIRST, 256, -1, true);
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestExactFirstMissingResultIterator()
        {
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestDupSurfaceFormsMissingResultsIterator()
        {
            Analyzer a = new TestDupSurfaceFormsMissingResultsAnalyzer(this);
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestDupSurfaceFormsMissingResults2Iterator()
        {
            Analyzer a = new TestDupSurfaceFormsMissingResults2Analyzer();
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void Test0ByteKeysIterator()
        {
            Analyzer a = new Test0ByteKeysAnalyzer();
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestDupSurfaceFormsMissingResults3Iterator()
        {
            Analyzer a = new MockAnalyzer(Random);
            AnalyzingSuggester suggester = new AnalyzingSuggester(a, a, SuggesterOptions.PRESERVE_SEP, 256, -1, true);
            suggester.Build(new InputArrayIterator(new Input[] {
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestEndingSpaceIterator()
        {
            Analyzer a = new MockAnalyzer(Random);
            AnalyzingSuggester suggester = new AnalyzingSuggester(a, a, SuggesterOptions.PRESERVE_SEP, 256, -1, true);
            suggester.Build(new InputArrayIterator(new Input[] {
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestTooManyExpansionsIterator()
        {
            Analyzer a = new TestTooManyExpressionsAnalyzer();
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestIllegalLookupArgumentIterator()
        {
            Analyzer a = new MockAnalyzer(Random);
            AnalyzingSuggester suggester = new AnalyzingSuggester(a, a, 0, 256, -1, true);
            suggester.Build(new InputArrayIterator(new Input[] {
