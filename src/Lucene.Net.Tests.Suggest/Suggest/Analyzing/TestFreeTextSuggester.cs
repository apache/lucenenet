...
namespace Lucene.Net.Search.Suggest.Analyzing
{
    ...
    public class TestFreeTextSuggester : LuceneTestCase
    {
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestIllegalByteDuringBuildIterator()
        {
            // Default separator is INFORMATION SEPARATOR TWO
            // (0x1e), so no input token is allowed to contain it
            IEnumerable<Input> keys = AnalyzingSuggesterTest.Shuffle(
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestIllegalByteDuringQueryIterator()
        {
            // Default separator is INFORMATION SEPARATOR TWO
            // (0x1e), so no input token is allowed to contain it
            IEnumerable<Input> keys = AnalyzingSuggesterTest.Shuffle(
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestUnigramsIterator()
        {
            IEnumerable<Input> keys = AnalyzingSuggesterTest.Shuffle(
                new Input("foo bar baz blah boo foo bar foo bee", 50)
            );
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestNoDupsAcrossGramsIterator()
        {
            IEnumerable<Input> keys = AnalyzingSuggesterTest.Shuffle(
                new Input("foo bar bar bar bar", 50)
            );
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestEmptyStringIterator()
        {
            IEnumerable<Input> keys = AnalyzingSuggesterTest.Shuffle(
                new Input("foo bar bar bar bar", 50)
            );
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestEndingHoleIterator()
        {
            // Just deletes "of"
            Analyzer a = new TestEndingHoleAnalyzer();
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestTwoEndingHolesIterator()
        {
            // Just deletes "of"
            Analyzer a = new TestEndingHoleAnalyzer();
