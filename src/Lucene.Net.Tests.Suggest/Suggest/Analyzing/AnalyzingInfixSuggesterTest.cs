...
namespace Lucene.Net.Search.Suggest.Analyzing
{
    ...
    public class AnalyzingInfixSuggesterTest : LuceneTestCase
    {
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestAfterLoadIterator()
        {
            Input[] keys = new Input[] {
                new Input("lend me your ear", 8, new BytesRef("foobar")),
                new Input("a penny saved is a penny earned", 10, new BytesRef("foobaz")),
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestHighlightAsObjectIterator()
        {
            Input[] keys = new Input[] {
                new Input("a penny saved is a penny earned", 10, new BytesRef("foobaz")),
            };
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestRandomMinPrefixLengthIterator()
        {
            Input[] keys = new Input[] {
                new Input("lend me your ear", 8, new BytesRef("foobar")),
                new Input("a penny saved is a penny earned", 10, new BytesRef("foobaz")),
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestHighlightIterator()
        {
            Input[] keys = new Input[] {
                new Input("a penny saved is a penny earned", 10, new BytesRef("foobaz")),
            };
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestHighlightCaseChangeIterator()
        {
            Input[] keys = new Input[] {
                new Input("a Penny saved is a penny earned", 10, new BytesRef("foobaz")),
            };
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestDoubleCloseIterator()
        {
            Input[] keys = new Input[] {
                new Input("a penny saved is a penny earned", 10, new BytesRef("foobaz")),
            };
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestSuggestStopFilterIterator()
        {
            CharArraySet stopWords = StopFilter.MakeStopSet(TEST_VERSION_CURRENT, "a");
            Analyzer indexAnalyzer = Analyzer.NewAnonymous(createComponents: (fieldName, reader) =>
            {
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestEmptyAtStartIterator()
        {
            Analyzer a = new MockAnalyzer(Random, MockTokenizer.WHITESPACE, false);
            using (AnalyzingInfixSuggester suggester = new AnalyzingInfixSuggester(TEST_VERSION_CURRENT, NewDirectory(), a, a, 3))
            {
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestBothExactAndPrefixIterator()
        {
            Analyzer a = new MockAnalyzer(Random, MockTokenizer.WHITESPACE, false);
            using (AnalyzingInfixSuggester suggester = new AnalyzingInfixSuggester(TEST_VERSION_CURRENT, NewDirectory(), a, a, 3))
            {
        ...
        [Slow]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestRandomNRTIterator()
        {
            DirectoryInfo tempDir = CreateTempDir("AnalyzingInfixSuggesterTest");
            Analyzer a = new MockAnalyzer(Random, MockTokenizer.WHITESPACE, false);
            int minPrefixChars = Random.nextInt(7);
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestBasicNRTIterator()
        {
            Input[] keys = new Input[] {
                new Input("lend me your ear", 8, new BytesRef("foobar")),
            };
        ...
        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestBasicContextIterator()
        {
            Input[] keys = new Input[] {
                new Input("lend me your ear", 8, new BytesRef("foobar"), AsSet("foo", "bar")),
                new Input("a penny saved is a penny earned", 10, new BytesRef("foobaz"), AsSet("foo", "baz"))
