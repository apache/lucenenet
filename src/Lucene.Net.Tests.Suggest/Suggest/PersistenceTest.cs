...
namespace Lucene.Net.Search.Suggest
{
    ...
    public class PersistenceTest : LuceneTestCase
    {
        ...
        public void TestTSTPersistenceIterator()
        {
            RunTestIterator(typeof(TSTLookup), true);
        }

        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestJaspellPersistenceIterator()
        {
            RunTestIterator(typeof(JaspellLookup), true);
        }

        [Test]
        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        public void TestFSTPersistenceIterator()
        {
            RunTestIterator(typeof(FSTCompletionLookup), false);
        }

        [Obsolete("This will be removed in 4.8.0 release candidate.")]
        private void RunTestIterator(Type lookupClass,
            bool supportsExactWeights)
        {
